...
public interface TREADReportService {

	List<Map<String,Object>> getProductionInfo(int year, int quarter);
	
	List<Map<String,Object>> getClaimsInfo(int year,int quarter);
