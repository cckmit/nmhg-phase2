 ...
 *
 */
public class MealsExpenseComputer extends AbstractPaymentComponentComputer {
	 public Money computeBaseAmount(PaymentContext ctx) {
        ...
        Money mealsExpense = serviceDetail.getMealsExpense();
        Currency baseCurrency = GlobalConfiguration.getInstance().getBaseCurrency();
        if( mealsExpense==null ) {
            mealsExpense = Money.valueOf(0,baseCurrency);
        }
        return mealsExpense;
    }
