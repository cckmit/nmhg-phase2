 ...
 */
public class RentalChargesComputer extends AbstractPaymentComponentComputer {
	 public Money computeBaseAmount(PaymentContext ctx) {
        ...
        Money rentalChargesExpense = serviceDetail.getRentalCharges();
        Currency baseCurrency = GlobalConfiguration.getInstance().getBaseCurrency();
        if (rentalChargesExpense == null) {
            rentalChargesExpense = Money.valueOf(0, baseCurrency);
        }
        return rentalChargesExpense;
    }
