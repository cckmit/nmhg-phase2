 ...
 * @author kiran.sg
 */
public class ParkingExpenseComputer extends AbstractPaymentComponentComputer {
	 public Money computeBaseAmount(PaymentContext ctx) {
        ...
        Money parkingExpense = serviceDetail.getParkingAndTollExpense();
        Currency baseCurrency = GlobalConfiguration.getInstance().getBaseCurrency();
        if (parkingExpense == null) {
            parkingExpense = Money.valueOf(0, baseCurrency);
        }
