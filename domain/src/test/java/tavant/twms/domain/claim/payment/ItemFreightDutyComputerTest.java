...
public class ItemFreightDutyComputerTest extends TestCase {

    public void testCompute() throws PaymentCalculationException {
        ...
        serviceDetail.setItemFreightAndDuty(Money.dollars(20));
        ServiceInformation serviceInformation = new ServiceInformation();
        
        serviceInformation.setServiceDetail(serviceDetail);
        claim.setServiceInformation(serviceInformation);
        
        ItemFreightDutyComputer fixture = new ItemFreightDutyComputer();
