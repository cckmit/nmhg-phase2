...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <xsl:variable name="bu" select="shipmentTag/businessUnit"/>
        <xsl:variable name="nonWarranty" select="shipmentTag/nonWarrantyAnalysis"/>
                        ...
                        <fo:table-body>
                            ...
                            <fo:table-row>
                                ...
                                <fo:table-cell>
                                    ...
                                    <fo:block>
                                        <fo:inline  left="90px" padding-start="30pt">
                                                Non-Warranty Vendor Analysis
                                        </fo:inline>
                                    </fo:block>
                                </fo:table-cell>
                                  </fo:table-row>
                           ...
                           <fo:table-body>
                                ...
                                <fo:table-cell padding-start="0.5cm">
                                    <fo:block>
                                        <fo:inline font-size="9pt" font-weight="bold" >
                                            <xsl:value-of
                                                    select="java:getString($resources,'label.partReturnConfiguration.supplierInstructionsOne')"/>:
                                        </fo:inline>
                                    </fo:block>
                                </fo:table-cell>
               ...
               <fo:table-cell>
                ...
                <fo:table-column column-width="18.88cm"/>
                   ...
                   <xsl:if test="claim/workPerformed">
                    ...
                    <fo:inline font-size="9pt">
                     <xsl:value-of
                             select="java:getString($resources,'label.partShipmentTag.supplierAdttionNotes')"/>
                     </fo:inline>                     
                     </fo:block>
                 </fo:block>
                ...
                <fo:flow flow-name="body">
                    ...
                    <fo:block><!-- List of parts block starts -->
                      ...
                      <fo:leader leader-length="100%" leader-pattern="space"> &#x00A0;</fo:leader>
                       <fo:block>   
                                      <fo:inline>
                                          Non-Warranty Analysis: <xsl:value-of select="$nonWarranty"/>
                                      </fo:inline>
                       </fo:block>  
                    </fo:block>
