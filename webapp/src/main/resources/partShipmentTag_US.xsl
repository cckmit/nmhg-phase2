                    ...
                    <fo:table border="solid 0.5px black" border-width="100%" table-layout="fixed" text-align="start">
                        ...
                        <fo:table-body>
                           ...
                           <fo:table-body>
                                ...
                                <xsl:if test = "part/shippingCommentsInRecClaim or part/shippingCommentsInClaim">
                                <fo:table-cell padding-start="0.1cm">
                                   <xsl:if test="part/shippingCommentsInRecClaim">
                                    <fo:block>
				                    <fo:inline font-size="9pt" >
									 Vendor/VendorProcessor : 
                                    <xsl:value-of   select="part/shippingCommentsInRecClaim"/>	
				                      </fo:inline>
                                    </fo:block>
                                          <fo:block>
                                         ...
                                         <xsl:if test="part/shippingCommentsInClaim">
                                    <fo:block font-family="sans-seriff">
				                    <fo:inline font-size="9pt" >
				                         Warranty Processor : 
										<xsl:value-of   select="part/shippingCommentsInClaim"/>	
				                      </fo:inline>
                                    </fo:block>
                                          <fo:block>
                                              <fo:leader leader-length="100%"
               ...
               <fo:table-cell>
                ...
                <fo:table-column column-width="18.88cm"/>
                   ...
                   <xsl:if test="claim/workPerformed">
                    ...
                    <fo:inline font-size="9pt">
                     <xsl:value-of
                             select="java:getString($resources,'label.partShipmentTag.adttionNotes')"/>
                     </fo:inline>
                     </fo:block>
                 </fo:block>
