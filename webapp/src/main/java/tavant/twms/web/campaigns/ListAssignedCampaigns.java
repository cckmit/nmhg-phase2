...
public class ListAssignedCampaigns extends SummaryTableAction {
	...
	protected PageResult<?> getBody() {
        ...
        return campaignAssignmentService
				.findAllCampaignNotificationsForDealer(createNotificationCriteria(
						dealersWhoseFPICanBeViewed, new PageSpecification(page - 1, pageSize)));
	}
	...
	protected List<SummaryTableColumn> getHeader() {
		...
		tableHeadData.add(new SummaryTableColumn("columnTitle.campaign.model","item.ofType.model.description",8,"String"));
	    ...
	    tableHeadData.add(new SummaryTableColumn("columnTitle.campaign.status","campaign.status",11,"String","campaign.status"));
