...
public class ListUpdatedCampaigns extends SummaryTableAction {
	...
	protected PageResult<?> getBody() {
        ...
        return campaignAssignmentService
				.findAllCampaignNotificationRequestsByStatus(createNotificationCriteria(
						dealersWhoseFPICanBeViewed, new PageSpecification(page - 1, pageSize)),FieldModUpdateStatus.SUBMITTED,isLoggedInUserADealer(),businessUnitName);
	}
