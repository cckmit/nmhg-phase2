...
<script type="text/javascript">
	...
	var __masterCheckBoxControls = new Array();
	 function invokePrintPopup(shipmentId){
			...
			var actionUrlString = 'partreturns_displayForPrint_wpraView.action?shipmentIdString='+ shipmentId+'&taskName=Parts Shipped&clientDate='+dateTime; 
...
<u:body>
    <div dojoType="dijit.layout.ContentPane" label="Parts List" style="overflow-X: hidden; overflow-Y: auto; width:100%;">
        ...
        <s:iterator value="shipments" status="shipmentItr">
