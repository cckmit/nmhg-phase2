...
<u:body >
    ...
    <s:form action="claimBasedGenerateWpra.action">
	  ...
	  <div class="inspectionResult" style="width:99%">
         <div align="left" style="padding: 2px; padding-left: 7px; padding-right: 10px;">
          ...
          <div class="buttonWrapperPrimary">
            ...
            <s:submit name="action:claimBasedRemovePartFromWpra" value="%{getText('button.partReturnConfiguration.returnNotRequired')}" cssClass="buttonGeneric" />
          </div>
      </div>
  	</div>
  </s:form>
