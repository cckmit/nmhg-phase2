...
<s:if test="reportType == 'claimsByProduct'">
<div class="snap">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="bgColor">
	...
	<tr>
		<td colspan="4" nowrap="nowrap" class="labelNormalTop"><s:text name="label.report.claimsByProductDescription"/></td>
	</tr>
</table>
<div id="separator"></div>
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="bgColor">
	...
	<s:submit cssClass="buttonGeneric" action="claimsByProductReport" value="%{getText('button.report.generate')}"/>
	</div>
</div>
</s:if>
