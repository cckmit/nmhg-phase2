...
<table class="report_data_table">
	<tr>
		...
		<td><s:select name="reportType"	list="partReturnReports" required="true"/></td>
		<td><s:submit cssClass="buttonGeneric" action="partReturnsReports" value="%{getText('button.common.go')}" onclick="javascript:deleteData()"/></td>
	</tr>
</table>
<jsp:include flush="true" page="duePartReturnsByDealer.jsp"/>
<jsp:include flush="true" page="partReturnEfficiencyByDealer.jsp"/>
