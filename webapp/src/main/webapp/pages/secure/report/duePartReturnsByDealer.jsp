...
<s:if test="reportType == 'duePartReturnsByDealer'">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="bgColor">
	...
	<tr>
		...
		<s:text name="label.report.duePartReturnsByDealerDescription" />
		</td>
	</tr>
</table>
<div id="separator"></div>
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="bgColor">
	...
	<s:submit cssClass="buttonGeneric" action="duePartReturnsReport" value="%{getText('button.report.generate')}" />
	</div>
</div>
</s:if>
