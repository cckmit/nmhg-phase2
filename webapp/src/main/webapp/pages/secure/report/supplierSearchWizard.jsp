	...
	<div dojoType="twms.widget.Dialog" id="searchDealersDialog" bgColor="#FFF" bgOpacity="0.5" toggle="fade" toggleDuration="250">
		<div dojoType="dijit.layout.LayoutContainer" style="width:500px; height:400px; background: #F3FBFE; border: 1px solid #EFEBF7;">
			...
			<div  dojoType="dijit.layout.ContentPane" layoutAlign="top" style="border-bottom:1px solid #EFEBF7">
				<table width="100%">
					<tr>
					    <td width="15%" class="label1"><s:text name="label.report.supplier" /></td>
						<td width="25%"><t:text id="supplierName" name="supplierName"/></td>
						<td  width="60%">
						<t:submit onclick="requestSuppliers" id="startSearch1" label="%{getText('button.common.search')}" cssClass="buttonGeneric"/>
						</td>
					</tr>
				</table>
			</div>
			<div dojoType="dijit.layout.ContentPane" layoutAlign="client" id="searchResultsDealer" style="background:#ffffff">
			</div>
			<div align="center" dojoType="dijit.layout.ContentPane" layoutAlign="bottom" style="border-top:1px solid #EFEBF7">
				<table width="100%">
					<tr>
					    <td width="5%">&nbsp;</td>
						<td>
						<t:submit onclick="addDealersToForm" id="addTerms1" label="%{getText('button.common.add')}" cssClass="buttonGeneric"/>
						</td>
						<td><div align="right">
						<t:submit onclick="closeDialogDealer" id="closeTerms1" label="%{getText('button.common.close')}" cssClass="buttonGeneric"/>
	         			</div>
	             		</td>
	             		<td width="5%">&nbsp;</td>
					</tr>
