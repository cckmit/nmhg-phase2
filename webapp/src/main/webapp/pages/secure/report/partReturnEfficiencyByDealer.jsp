...
<s:if test="reportType == 'partReturnEfficiencyByDealer'">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="bgColor">
	<tr>
		...
		<s:text name="label.report.description" />
		</td>
	</tr>
	<tr>
		<td colspan="4" nowrap="nowrap" class="labelNormalTop">
		<s:text name="label.report.partReturnEfficiencyByDealerDescription" />
		</td>
	</tr>
</table>
<div id="separator"></div>
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="bgColor">
	<tr>
		<td colspan="4" class="sectionTitle">
		<s:text	name="label.report.specifyReportParameters" />
		</td>
	</tr>
	<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<tbody id="dealerGroupsTable">
						<tr>
						<td width="5%"><input type="radio" name="optionSelected" value="dealerGroups" id="dealerGroup" onclick="removeDealers()"
							<s:if test="optionSelected=='dealerGroups'">checked="checked"</s:if> />
						</td>
	...
	<s:submit cssClass="buttonGeneric" action="partReturnEfficiencyReport" value="%{getText('button.report.generate')}" />
	</div>
</div>
</s:if>
