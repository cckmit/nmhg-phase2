...
<s:if test="reportType == 'supplierRecovery'">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="bgColor">
	...
	<tr>
		...
		<s:text name="label.report.supplierRecoveryDescription" />
		</td>
	</tr>
</table>
<div id="separator"></div>
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="bgColor">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<tbody id="dealersTable">
				        ...
				        <td width="95%" class="label"><s:text name="label.report.supplier" />
	...
	<s:submit cssClass="buttonGeneric" action="supplierRecoveryJasper" value="%{getText('button.report.generate')}"/>
	</div>
</div>
</s:if>
