...
<div>
    <div dojoType="twms.widget.Dialog" id="fileUploadDialog" style="width:60%;overflow-y: auto;" title="Attach Documents">    
...
<script type="text/javascript">
    ...
    var _uploadFileWizard = {
        ...
        callback : function(message) {
            if(this.usersCallback) {
             ...
             this.hideDialog();
             if( dojo.byId("commonAttachLink")){
              	dojo.byId("commonAttachLink").innerHTML='Modify/Remove Common Attachments';
              }
        },
        usersCallback : null,
        hideDialog : function() {
        ...
        setDialogHeight : function(/*int*/ batchSize) {
            ...
            dojo.style(dijit.byId("dialogLayoutContainer").domNode, "height",
    ...
    dojo.addOnLoad(function() {
        ...
        dojo.subscribe("/uploadDocument/dialog/show", null, function(/*attrs 'callback' and 'onClose'*/message) {
            ...
            dijit.byId("fileUploadDialog").show();
        });
