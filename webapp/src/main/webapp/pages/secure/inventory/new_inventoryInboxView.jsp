...
<head>
    ...
    <script type="text/javascript">
		...
		function handleShowSearch(event, dataId) {		
          ...
          formObj.action = "showPredefinedInventoryQuery.action";
          formObj.submit();
		}
        ...
        var extraParams = {
			...
			searchQueryName : '<s:property value="savedQueryName"/>'
		};

        function exportToExcel(){
         exportExcel("/inventory/populateCriteria","downloadInvToExcel.action");
        }
  ...
  <div dojoType="dijit.layout.LayoutContainer" style="width: 100%; height: 100%" id="inventoryInboxViewRootLayout">
    <div dojoType="dijit.layout.ContentPane" layoutAlign="top" class="buttonContainer" id="inventoryInboxViewButtonPane">
		...
		<u:summaryTableButton id="deleteQueryButton" label="button.common.delete" onclick="deleQuery" summaryTableId="inventoryTable" cssClass="new_warranty_registration_button"/>
		</s:if>
      ...
      <authz:ifUserInRole roles="inventoryAdmin,dealer">
     
        <s:if test="inventorySearchCriteria.inventoryType.type=='STOCK'">
			<s:if test="wntyRegAllowed">
    	...
    	<div style="clear: both;">
    		<authz:ifUserInRole roles="dealerWarrantyAdmin,processor">
    		 <s:if test="isStockClaimAllowed() && inventorySearchCriteria.inventoryType.type=='STOCK'">
...
<authz:ifPermitted resource="inventoryPredefinedStockSearchReadOnlyView">
	<script type="text/javascript">
		dojo.addOnLoad(function() {
			document.getElementById("inventoryInboxViewButtonPane").style.display="none";
		});
	</script>
</authz:ifPermitted>
<authz:ifPermitted resource="inventoryPredefinedRetailSearchReadOnlyView">
	<script type="text/javascript">
		dojo.addOnLoad(function() {
			document.getElementById("inventoryInboxViewButtonPane").style.display="none";
		});
