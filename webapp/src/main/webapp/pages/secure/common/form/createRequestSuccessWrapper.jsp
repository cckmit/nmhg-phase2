...
<u:body>
    <div dojoType="dijit.layout.LayoutContainer" style="overflow-y:auto; width: 100%; height: 100%">
    
        <div dojoType="dijit.layout.ContentPane" layoutAlign="client">
        <jsp:include page="common/actionResults.jsp"/>
            <s:form action="%{createSubmitAction}" validate="%{ajaxValidatable}" theme="twms" method="POST">
                ...
                <div class="formButtonContainer">
                    ...
                    <% request.setAttribute(CRUDFormAction.SAVE_BUTTON_ACTION,
                            request.getAttribute(ActionType.CREATE_SUBMIT.toString()));%>
