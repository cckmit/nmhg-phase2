...
<script type="text/javascript">
    ...
    dojo.require("dojox.layout.ContentPane");
		...
		function exportToExcel(){
         exportExcel("/alarmCode/populateCriteria","export_alarm_code_to_excel.action");
        }
...
<u:body>
	...
	<div dojoType="dijit.layout.ContentPane" layoutAlign="top"
		...
		cssClass="refresh_button" summaryTableId="alarmCodeTable" />
		
		<u:summaryTableButton
		id="createAlarmCodeButton" label="label.alarmcode.createAlarmCode"
		onclick="createAlarmCode" summaryTableId="alarmCodeTable"
		cssClass="create_warehouse_button" /> 
		
		<u:summaryTableButton
		id="downloadListing" label="button.common.downloadToExcel"
		onclick="exportToExcel" align="right"
		cssClass="download_to_excel_button" summaryTableId="alarmCodeTable" />
	</div>
