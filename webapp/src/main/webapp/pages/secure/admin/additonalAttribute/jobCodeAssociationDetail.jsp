...
<u:body>
<s:form action="attributes_job_code_associate.action" id="attrForm" theme="twms" validate="true">
...
<jsp:include flush="true" page="jobCodeAssociation.jsp"></jsp:include>
...
<authz:ifPermitted resource="warrantyAdminAssociate/DissociateFlatRatesAttributesReadOnlyView">
	<script type="text/javascript">
	    dojo.addOnLoad(function() {
	        for ( var i = 0; i < dojo.query("input, button, textarea, select, text", dojo.byId('attrForm')).length; i++) {
	            dojo.query("input, button, textarea, select, text", dojo.byId('attrForm'))[i].disabled=true;
	        }
	    });
	</script>
</authz:ifPermitted>
