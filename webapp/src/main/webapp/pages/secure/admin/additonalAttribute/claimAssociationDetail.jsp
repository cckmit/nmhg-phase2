...
<u:body>
<s:form action="attributes_Claim_associate.action" id="attrForm" theme="twms" validate="true">
...
<jsp:include flush="true" page="claimAssociation.jsp"></jsp:include>
...
<authz:ifPermitted resource="warrantyAdminAssociate/DissociateClaimAttributesReadOnlyView">
	<script type="text/javascript">
