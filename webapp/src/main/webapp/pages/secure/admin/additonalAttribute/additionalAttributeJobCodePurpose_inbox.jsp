...
function exportToExcel(){
   exportExcel("/attributes/populateCriteria","exportJobCodeAttributesListToExcel.action");
}
...
<div dojoType="dijit.layout.LayoutContainer" style="width: 100%; height: 100%">
	...
	<div dojoType="dijit.layout.SplitContainer" layoutAlign="client"
		...
		<u:stylePicker fileName="SummaryTableButton.css" /> <u:summaryTable id="attributes_invTable" eventHandlerClass="tavant.twms.summaryTable.BasicTwmsEventHandler"
			bodyUrl="attributes_job_code_table_body.action" folderName="%{folderName}"
			previewUrl="attributes_job_code_preview.action"
			detailUrl="attributes_job_code_detail.action" previewPaneId="preview"
