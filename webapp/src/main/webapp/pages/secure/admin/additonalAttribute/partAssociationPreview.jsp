...
<div dojoType="dijit.layout.LayoutContainer"
	...
	<div dojoType="dijit.layout.ContentPane" title="<s:text name="title.additionalAtrribute.associateParts"/>" style="overflow-X: none; overflow-Y: auto">
		<div class="policy_section_div">
			<div class="section_header"><s:text name="title.additionalAtrribute.associateParts"/></div>
			<jsp:include flush="true" page="associatedParts.jsp"/>
		</div>	
	</div>
	</div>
	</div>
