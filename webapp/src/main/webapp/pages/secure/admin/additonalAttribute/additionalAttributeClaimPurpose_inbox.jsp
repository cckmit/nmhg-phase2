...
<div dojoType="dijit.layout.LayoutContainer" style="width: 100%; height: 100%">
	...
	<div dojoType="dijit.layout.SplitContainer" layoutAlign="client"
		...
		<u:stylePicker fileName="SummaryTableButton.css" /> <u:summaryTable id="attributes_invTable" eventHandlerClass="tavant.twms.summaryTable.BasicTwmsEventHandler"
			bodyUrl="attributes_claim_table_body.action" folderName="%{folderName}"
			previewUrl="attributes_claim_preview.action"
			detailUrl="attributes_claim_association_detail.action" previewPaneId="preview"
