...
<u:body>
<s:form action="attributes_Claimed_inventory_associate.action" id="attrForm1" theme="twms" validate="true">
...
<jsp:include flush="true" page="claimedInventoryAssociation.jsp"></jsp:include>
...
<authz:ifPermitted resource="warrantyAdminAssociate/DissociateClaimedInventoryAttributesReadOnlyView">
	<script type="text/javascript">
	    dojo.addOnLoad(function() {
	        for ( var i = 0; i < dojo.query("input, button, textarea, select, text", dojo.byId('attrForm1')).length; i++) {
	            dojo.query("input, button, textarea, select, text", dojo.byId('attrForm1'))[i].disabled=true;
	        }
	    });
	</script>
</authz:ifPermitted>
