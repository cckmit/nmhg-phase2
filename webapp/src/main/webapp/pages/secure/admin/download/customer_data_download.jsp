...
<div class="admin_section_div" style="width:102%;margin-right:0px;" >
    ...
    <table width="100%" cellspacing="0" cellpadding="0" class="grid">
	  ...
	  <tr>
		  <td class="labelBold" width="16%"><s:text name="label.downloadMgt.customerType"/>:</td>
		  <td><s:select list="customerTypes" name="reportSearchBean.customerType" listKey="key" listValue="value" headerKey="ALL" headerValue="All"  /></td>
	  </tr>
	      ...
	      <td class="labelBold">
		      <s:if test="loggedInUserAnInternalUser">
		  	  ...
		  	  <s:else>
		  		...
		  		<s:property value="%{loggedInUsersDealership.dealerNumber}" />
		  	  </s:else>
	  	  </td>
  	  </tr>
      <tr>
       ...
       <div align="center" class="spacingAtTop">
			<s:submit cssClass="buttonGeneric" value="%{getText('button.common.submit')}" 
				type="input" id="downloadCustomerData" action="downloadCustomerData" />
		</div>
</s:form>
</u:body>