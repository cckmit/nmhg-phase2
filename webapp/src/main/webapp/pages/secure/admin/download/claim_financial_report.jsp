...
<s:hidden name="reportSearchBean.submitOrCreditOrUpdateDate" value="submitDate"/>
  ...
  <div class="admin_section_div">
    ...
    <table width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr width="100%">
      	...
      	<s:text name="label.downloadMgt.clamFinancialReport"/></div></td>
      </tr> 
      <tr rowspan="3"><td colspan="3">&nbsp;</td></tr>
      <tr width="100%">
  		<td class="labelBold" colspan="3"><s:property value="userNotes"/></td>
  	  </tr> 
      <tr rowspan="3"><td colspan="3">&nbsp;</td></tr>
      <tr>
      ...
      <tr>
		...
		<td colspan="2" class="labelBold"><s:textfield name="reportSearchBean.dealerNumber" />
      ...
      <tr>
		<td align="center">
			<s:submit cssClass="buttonGeneric" value="%{getText('button.common.submit')}" 
				type="input" id="downloadClaimDetailData" action="downloadClaimFinancialReportData" />
		</td><td colspan="2">&nbsp;</td>
	  </tr>
