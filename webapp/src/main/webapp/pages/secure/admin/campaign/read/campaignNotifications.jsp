...
<div class="admin_section_div" style="width: 99%">
    ...
    <table class="admin_selections" width="100%">
	  ...
	  <tr>  
	    ...
	    <td align="center">
	    	<s:checkbox name="campaign.notifiyDealerByEmail" disabled="true"/>
		</td>
		<td align="center">
			<s:checkbox name="campaign.notifyCustomer" disabled="true"/>
		</td>
		<td>&nbsp;</td>
	  </tr>
	  <tr>  
	    ...
	    <td align="center">
	    	<s:checkbox name="campaign.notifyDealer" disabled="true"/>
		</td>
		<td colspan="2">&nbsp;</td>
	  </tr>
	</table>
