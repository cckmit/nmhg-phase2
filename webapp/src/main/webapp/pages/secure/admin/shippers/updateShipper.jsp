			   ...
			   <div class="borderTable">&nbsp;</div>
				<div  style="margin-top:-10px; ">
					...
					<tr>
					  ...
					  <td ><s:property value="%{carrier.name}"/></td>
					 </tr>
					 <tr>
				...
				<div align="center" class="spacingAtTop">
					...
					<s:submit cssClass="buttonGeneric" value="%{getText('button.common.delete')}" action="delete_shipper"/>
					<s:submit cssClass="buttonGeneric" value="%{getText('button.common.save')}" action="update_shipper"/>
				</div>
			</div>
		</s:form>
	</u:body>
