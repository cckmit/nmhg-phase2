...
<u:body>
    <u:actionResults/>
    <s:form name="buForm" action="searchServiceProvider" id="baseFormId">
        ...
        <div dojoType="dijit.layout.LayoutContainer"
            ...
            <div id="bu_user_search_div" class="section_header">
                <s:text name="title.bu.dealer.mapping"/>
            </div>
            <table width="100%" border="0" cellspacing="6" cellpadding="6"
                   class="header">
                   <tr>

                    <td  width="20%" nowrap="nowrap" ><s:label value="%{getText('label.common.dealerNumber')}" cssClass="labelStyle" /></td>

                    <td >
                        <s:textfield name="dealerNumber" id="searchText"/>
...
<authz:ifPermitted resource="settingsMapServiceProviderBusinessUnitReadOnlyView">
	<script type="text/javascript">
	    dojo.addOnLoad(function() {
