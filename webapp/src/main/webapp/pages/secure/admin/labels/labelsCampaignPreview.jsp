	 		...
	 		<tr >
	 			<td colspan="3">
	 				<div  class="section_header">        
        	  			<s:text name="label.common.campaignLabels"/>
       				</div>
       			</td>		
      		 </tr>
      		 <tr class="admin_table_header">
      		 	<th class="labelStyle">
      		 		<s:text name="label.campaign.campaignCode"/>
      		 	</th>
      		 	<th class="labelStyle">
      		 		<s:text name="columnTitle.common.description"/>
      		 	</th>
      		 	<th class="labelStyle">
      		 		<s:text name="label.campaign.status"/>
      		 	</th>
      		 </tr>
      		 <s:iterator  value="campaigns" status="itr" id="localesItr">
      		<tr>
