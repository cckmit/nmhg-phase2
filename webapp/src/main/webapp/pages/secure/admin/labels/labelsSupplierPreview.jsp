	 		...
	 		<tr>
	 			<td colspan="3">
	 				<div  class="section_header">        
        	  			<s:text name="label.common.supplierLabels"/>
       				</div>
       			</td>		
      		 </tr>
      		 <tr class="admin_table_header">
      		 	<th>
      		 		<s:text name="label.supplier.supplierNumber"/>
      		 	</th>
      		 	<th>
      		 		<s:text name="label.campaign.preferredLocationType"/>
      		 	</th>
      		 </tr>
      		 <s:iterator  value="suppliers" status="itr" id="localesItr">
      		<tr>
				<td  class="label">
					<s:property value='supplierNumber'/>
				</td>
				<td class="label">
					<s:property value='preferredLocationType'/>
				</td>
