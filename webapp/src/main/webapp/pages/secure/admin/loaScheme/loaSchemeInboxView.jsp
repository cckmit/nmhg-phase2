...
<head>
  ...
  <div dojoType="dijit.layout.SplitContainer" layoutAlign="client"
         ...
         persist="false">
  <u:stylePicker fileName="SummaryTableButton.css" /> <u:summaryTable eventHandlerClass="tavant.twms.summaryTable.BasicTwmsEventHandler" id="loaSchemeTable"
                          bodyUrl="get_loa_schemes_body.action"
                          folderName="%{folderName}"
                          detailUrl="manage_loa_scheme.action"
                          previewUrl="preview_loa_scheme.action"
  ...
  <div dojoType="dojox.layout.ContentPane" id="preview">
         ...
         <script type="text/javascript">
		          dojo.addOnLoad(function(){
		            dojo.style(dojo.byId("loaSchemeTable_summaryTable_showHidePreview"),"display","none");
		       		 });
          </script>
    </div>
