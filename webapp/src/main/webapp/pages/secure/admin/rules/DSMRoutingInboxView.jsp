...
<html>
<head>
    <title><s:text name="title.manageBusinessRule.DSMRouting"/></title>
    <s:head theme="twms" />
    ...
    <script type="text/javascript">
        ...
        function createDomainRule() {
            parent.publishEvent("/tab/open", {
                ...
                url: "create_DSM_routing_rule.action?context=" + extraParams.context,
                forceNewTab: true
            });
        }
        ...
        function exportToExcel(){
            exportExcel("/DSMRoutingRules/populateCriteria","exportRulesToExcel.action");
        }
  ...
  <div dojoType="dijit.layout.LayoutContainer" layoutChildPriority="top-bottom"
    ...
    <div dojoType="dijit.layout.SplitContainer" layoutAlign="client"
        ...
        <u:stylePicker fileName="SummaryTableButton.css" /> <u:summaryTable eventHandlerClass="tavant.twms.summaryTable.BasicTwmsEventHandler" id="domainRuleTable"
                          bodyUrl="get_DSM_routing_rules_body.action"
                          extraParamsVar="extraParams"
                          folderName="BUSINESS_RULES"
                          previewUrl="manage_DSM_routing_rule_detail.action"
                          detailUrl="manage_DSM_routing_rule_detail.action"
                          previewPaneId="preview"
                          populateCriteriaDataOn="/DSMRoutingRules/populateCriteria"
                          parentSplitContainerId="split">
            <s:iterator value="tableHeadData">
                 <u:summaryTableColumn id="%{id}" label="%{title}" width="%{widthPercent}"
                                      idColumn="%{idColumn}" labelColumn="%{labelColumn}" hidden="%{hidden}"
