...
<div class="policy_section_div">
    <div class="admin_section_heading">
    	<s:text name="label.manageBusinessRule.createRecClaimProcessorRoutingRule"/>
 	</div>
    ...
    <div class="admin_section_div" style="width: 99%;" >
            <div class="colHeader" style="height:30px;">
                ...
                <s:submit cssClass="buttonGeneric" action="search_predicates_for_new_rec_processor_routing_rule"
    ...
    <div align="center" class="spacingAtTop">
                ...
                <s:submit cssClass="buttonGeneric" action="save_rec_processor_routing_rule"
