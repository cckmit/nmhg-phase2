...
<html>
<head>
    <title><s:text name="title.manageBusinessRule.CPAdvisorRouting"/></title>
    <s:head theme="twms" />
    ...
    <script type="text/javascript">
        ...
        function createDomainRule() {
            parent.publishEvent("/tab/open", {
                ...
                url: "create_CP_advisor_routing_rule.action",
                forceNewTab: true
            });
        }
        
        var extraParams = {
            context : "CPAdvisorRouting"
        };
        
        function exportToExcel(){
            exportExcel("/CPAdvisorRoutingRules/populateCriteria","exportRulesToExcel.action");
        }
  ...
  <div dojoType="dijit.layout.LayoutContainer" layoutChildPriority="top-bottom"
    ...
    <div dojoType="dijit.layout.SplitContainer" layoutAlign="client"
        ...
        <u:stylePicker fileName="SummaryTableButton.css" /> <u:summaryTable eventHandlerClass="tavant.twms.summaryTable.BasicTwmsEventHandler" id="domainRuleTable"
                          bodyUrl="get_CP_advisor_routing_rules_body.action"
                          extraParamsVar="extraParams"
                          folderName="BUSINESS_RULES"
                          previewUrl="manage_CP_advisor_routing_rule_detail.action"
                          detailUrl="manage_CP_advisor_routing_rule_detail.action"
                          previewPaneId="preview"
                          populateCriteriaDataOn="/CPAdvisorRoutingRules/populateCriteria"
