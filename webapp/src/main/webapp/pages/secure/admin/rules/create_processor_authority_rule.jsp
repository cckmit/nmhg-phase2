...
<div class="admin_section_div" >
    <div class="admin_section_heading">
    	<s:text name="label.manageBusinessRule.createProcessorAuthorityRule"/>
 	</div>
...
<tr>
	<s:if test="searchProcessed">
        ...
        <s:if test="!predicates.isEmpty()">
        	<td colspan="2" class="labelStyle"><s:text name="columnTitle.manageBusinessRule.authorizedAction"/></td>
            <td style="border-bottom:1px solid #FCF9F3;">
				<s:select name="selectedAssignedTo" list="availableActionsOnClaim" multiple="true" size="3" theme="simple"  
...
<div class="admin_section_div" >
    ...
    <div class="colHeader" style="height: 30px;">
        ...
        <s:submit cssClass="buttonGeneric" action="search_predicates_for_new_processor_authority_rule"
...
<div class="spacingAtTop" align="center">
        ...
        <s:submit cssClass="buttonGeneric" action="save_processor_authority_rule"
