...
<html>
<head>
    <title><s:text name="title.manageBusinessRule.processorAuthority"/></title>
    <s:head theme="twms" />
    ...
    <script type="text/javascript">
        ...
        function createDomainRule() {
            parent.publishEvent("/tab/open", {
                ...
                url: "create_processor_authority_rule.action",
                forceNewTab: true
            });
        }
        
        var extraParams = {
            context : "ProcessorAuthority"
        };
        
        function exportToExcel(){
            exportExcel("/ProcessorAuthorityRules/populateCriteria","exportRulesToExcel.action");
        }
  ...
  <div dojoType="dijit.layout.LayoutContainer" layoutChildPriority="top-bottom"
    ...
    <div dojoType="dijit.layout.ContentPane" layoutAlign="top" class="buttonContainer"
                    cssClass="delete_button" summaryTableId="domainRuleTable"  id="buttonsDiv"/>
        ...
        <u:summaryTableButton id="createProcessorAuthorityRuleButton"
    ...
    <div dojoType="dijit.layout.SplitContainer" layoutAlign="client"
        ...
        <u:stylePicker fileName="SummaryTableButton.css" /> <u:summaryTable eventHandlerClass="tavant.twms.summaryTable.BasicTwmsEventHandler" id="domainRuleTable"
                          bodyUrl="get_processor_authority_rules_body.action"
                          extraParamsVar="extraParams"
                          folderName="BUSINESS_RULES"
                          previewUrl="manage_processor_authority_rule_detail.action"
                          detailUrl="manage_processor_authority_rule_detail.action"
                          previewPaneId="preview"
                          populateCriteriaDataOn="/ProcessorAuthorityRules/populateCriteria"
