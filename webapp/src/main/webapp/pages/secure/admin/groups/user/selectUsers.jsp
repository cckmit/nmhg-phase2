...
<div style="overflow: auto;width:100%;">
	<table width="100%">
	  <tr>
	  	...
	  	<th class="admin_table_heading"><s:text name="label.manageGroup.userName"/></th>
	  </tr>
	  <tr>
	  	<td class="admin_table_subheading" align="center"><input type="checkbox" onclick="toggleOptions('included', this.checked)" /></td>
			<td colspan="2" align="center" class="admin_table_subheading"><s:text name="label.manageGroup.alreadySelectedUsers"/></td>
		</tr>
		<s:iterator value="includedUsers">
			<s:if test="%{availableUsers.contains(top)}">
				<tr>
					<td align="center">
		...
		<tr>
			...
			<td colspan="1" align="center" class="admin_table_subheading"><s:text name="label.manageGroup.selectMoreUsers"/></td>
		</tr>
  	<s:iterator value="users" status="iter">
			<s:if test="%{includedUsers.contains(top)}"></s:if>
	  	<s:else>
	  		<tr>
		  		<td align="center">
						<s:if test="%{availableUsers.contains(top)}">
