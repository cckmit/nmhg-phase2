...
<head>
    ...
    <script type="text/javascript">
        ...
        function createDealerGroup(evt) {
		var url ="create_dealer_group.action?id=" + "<s:property value="computedSchemeId"/>";
            parent.publishEvent("/tab/open", {
                label: i18N.new_dealerGroup,
        ...
        function exportToExcel(){
         exportExcel("/dealerGroup/populateCriteria","export_dealer_group_to_excel.action");
        }
  ...
  <div dojoType="dijit.layout.LayoutContainer" style="width: 100%; height: 100%">
    <div dojoType="dijit.layout.ContentPane" layoutAlign="top" class="buttonContainer">
        <u:summaryTableButton id="refreshButton" label="button.common.refresh"
                    ...
                    summaryTableId="dealerGroupTable"/>
        <u:summaryTableButton id="createDealerGroupButton"
                    label="button.manageGroup.createDealerGroup"
                    onclick="createDealerGroup"
                    summaryTableId="dealerGroupTable"
                    cssClass="create_dealerGroups_button"/>
    ...
    <div dojoType="dijit.layout.SplitContainer" layoutAlign="client"
        ...
        <u:stylePicker fileName="SummaryTableButton.css" /> <u:summaryTable eventHandlerClass="tavant.twms.summaryTable.BasicTwmsEventHandler" id="dealerGroupTable"
                          bodyUrl="get_dealer_groups_body.action"
                          folderName="DEALER_GROUPS"
                          previewUrl="view_dealer_group_preview.action"
                          detailUrl="view_dealer_group.action"
                          previewPaneId="preview"
                          parentSplitContainerId="split" extraParamsVar="extraParams"
                          populateCriteriaDataOn="/dealerGroup/populateCriteria">
