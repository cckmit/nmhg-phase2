...
<div class="admin_section_div" style="margin:5px;">
	...
	<div style="padding:4px;" class="label">
			...
			<span class="labelNormal"><s:textfield name="roleScheme.name"/></span>
	</div>
	...
	<div align="center" class="spacingAtTop">
		<s:submit cssClass="buttonGeneric" action="save_role_scheme" value="%{getText('button.common.save')}" />
