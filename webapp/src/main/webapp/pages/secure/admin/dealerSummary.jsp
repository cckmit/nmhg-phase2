...
<head>
    ...
    <script type="text/javascript">
        ...
        function populateDataForDealer(/*dealerid*/ id) {
            dojo.html.hide(dojo.byId("dealerData"));
            dojo.html.show(dojo.byId("loadingIndicationDiv"));
            twms.ajax.fireHtmlRequest("list_dealer_hierachy_dealer_summary.action", {dealerId:id}, function(data) {
                dijit.byId("dealerData").setContent(data);
                dojo.html.show(dojo.byId("dealerData"));
                dojo.html.hide(dojo.byId("loadingIndicationDiv"));
            });
        }
...
<u:body>
	<u:actionResults />
            ...
            <div class="admin_section_div" style="width:99%.5%" id="baseDiv">
            <div id="dealerSummary_header" class="section_header">
                <s:text name="Dealer Summary"/>
            </div>
        ...
        <div dojoType="dojox.layout.ContentPane" id="dealerData"></div>
