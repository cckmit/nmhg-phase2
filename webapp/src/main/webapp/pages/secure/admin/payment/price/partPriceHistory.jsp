...
<table class="grid borderForTable" cellspacing="0" align="center" cellpadding="0" style="width:95% ">
	<thead>
		...
		<s:hidden  name="nmhgPartNumber" value="%{definition.nmhg_part_number.number}"/>
		<s:iterator value="definition.partPriceAudits" status="stat">  
		 <tr>
               ...
               <script type="text/javascript">
                dojo.addOnLoad(
                    function() {
                        ...
                        event.url = "history_part_prices_configuration.action?partPriceAuditID=<s:property value='id' />&nmhgPartNumber=<s:property value='%{definition.nmhg_part_number.number}' />";
                        event.decendentOf = "Create Part Price";
