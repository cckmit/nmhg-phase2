...
<head>
    ...
    <script type="text/javascript">
        ...
        function createPartPriceConfig(event, dataId) {
            ...
            var url = "view_part_prices_configuration.action?createlrpage=true";
						parent.publishEvent("/tab/open", {
									label: i18N.create_part_prices_configuration,
									url: url,
		...
		function exportToExcel(){
         exportExcel("/partPrice/populateCriteria","export_part_prices_configuration_to_excel.action");
        }
    </script>
  ...
  <div dojoType="dijit.layout.LayoutContainer" style="width: 100%; height: 100%">
    <div dojoType="dijit.layout.ContentPane" layoutAlign="top" class="buttonContainer" id="buttonsDiv">
        ...
        <u:summaryTableButton id="warrantyRegButton" label="button.manageRates.createPartsCost" onclick="createPartPriceConfig" summaryTableId="partPriceConfigTable" cssClass="new_warranty_registration_button"/>
    ...
    <div dojoType="dijit.layout.SplitContainer" layoutAlign="client" orientation="vertical" sizerWidth="4" activeSizing="false" id="split" persist="false">
        <u:stylePicker fileName="SummaryTableButton.css" /> <u:summaryTable eventHandlerClass="tavant.twms.summaryTable.BasicTwmsEventHandler" id="partPriceConfigTable" bodyUrl="get_part_prices_configuration_body.action" folderName="%{folderName}" previewUrl="preview_part_prices_configuration.action" detailUrl="view_part_prices_configuration.action"
                          previewPaneId="preview" parentSplitContainerId="split"
                          populateCriteriaDataOn="/partPrice/populateCriteria">
