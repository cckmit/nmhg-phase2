...
<table class="grid borderForTable" cellspacing="0" align="center" cellpadding="0" style="width:95% ">
	<thead>
		<tr class="row_head">
		    <th width="20%" nowrap="nowrap" class="colHeader" style="border:1px solid #fff"><s:text name="label.common.dealer"/>/ <s:text name="label.common.dealerGroupLabel"/></th>
			...
			<th width="10%" nowrap="nowrap" class="colHeader" style="border:1px solid #fff"><s:text name="label.policyAudit.status" /></th>			
			<th width="10%" nowrap="nowrap" class="colHeader" style="border:1px solid #fff"><s:text name="label.common.details"/></th>
		</tr>
		<s:hidden id="size" value="definition.laborRateAudits.size()"/>
		<s:iterator value="definition.laborRateAudits" status="stat">  
		 <tr>
		  <td width="20%" style="padding:5px 5px 5px 5px ">
		    <s:if test="dealerCriterion == null">
                  <s:text name="label.common.allDealers"/>
            </s:if><s:else>
                  <s:property value="dealerCriterion.getIdentifier()"/>
            </s:else>
            </td>
               ...
               <script type="text/javascript">
                dojo.addOnLoad(
                    function() {
                        ...
                        event.label = "Audit History Details";
                        event.url = "history_lr_configuration.action?laborAuditID=<s:property value='id' />";
                        event.decendentOf = "Create Labor Rate";
