...
<head>
    ...
    <script type="text/javascript">
        ...
        function createStateMandates() {
			var url = "initialize_stateMandates.action";
            parent.publishEvent("/tab/open", {
                url: url,
                label: i18N.create_stateMandates,
        ...
        function exportToExcel() {
        	exportExcel("/stateMandates/populateCriteria","exportDataToExcel.action");
        } 
  ...
  <div dojoType="dijit.layout.LayoutContainer" style="width: 100%; height: 100%">
    <div dojoType="dijit.layout.ContentPane" layoutAlign="top" class="buttonContainer" id="buttonsDiv">
        ...
        <u:summaryTableButton id="refreshButton" label="button.common.refresh"
                    ...
                    summaryTableId="stateMandatesTable"/>
        <u:summaryTableButton id="createStateMandatesButton"
                    label="button.stateMandates.createStateMandates"
                    onclick="createStateMandates"
                    summaryTableId="stateMandatesTable"
      ...
      <div dojoType="dijit.layout.SplitContainer" layoutAlign="client"
        ...
        <u:stylePicker fileName="SummaryTableButton.css" /> 
                <u:summaryTable eventHandlerClass="tavant.twms.summaryTable.BasicTwmsEventHandler" id="stateMandatesTable"
                          bodyUrl="get_stateMandates.action" 
                          folderName="STATEMANDATES" 
                          previewUrl="preview_stateMandates.action"
                          detailUrl="detail_stateMandates.action" 
                          previewPaneId="preview"
                          parentSplitContainerId="split"
                          populateCriteriaDataOn="/stateMandates/populateCriteria">
