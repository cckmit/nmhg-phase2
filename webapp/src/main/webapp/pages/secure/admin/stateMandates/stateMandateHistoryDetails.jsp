        ...
        <table class="grid" width="100%" style="margin-top:10px;">
            <tr>
             <td class="labelStyle" width="20%" nowrap="nowrap"><s:text name="label.stateMandates.state" />:
               ...
               <td><s:property value="stateMandateAudit.state" /></td>
            </tr>
            
            <tr>
             <td class="labelStyle" width="20%" nowrap="nowrap"><s:text name="label.stateMandates.effectiveDate" />:
            </td>
             <td><s:property value="stateMandateAudit.effectiveDate" /></td>
            </tr>
            
            <tr>
             <td class="labelStyle" width="20%" nowrap="nowrap"><s:text name="label.stateMandates.laborRateType" />:
            </td>
             <td><s:property value="stateMandateAudit.laborRateType.description" /></td>
            </tr>
            
              <tr>
              <td class="labelStyle" width="20%" nowrap="nowrap"><s:text name="label.stateMandates.oemParts"/>:
              </td>
                 <td><s:property value="stateMandateAudit.oemPartsPercent" /></td>
            </tr>
            
            <s:iterator value="stateMandateAudit.stateMandateCostCtgAudit" status="status">
            <tr nowrap="nowrap">
            ...
            <s:else>
             ...
             <tr>
              <td class="labelStyle" width="20%"><s:text name="label.warrantyAdmin.comments"/>:
              </td>
                  <td><s:property value="stateMandateAudit.comments" /></td>
            </tr>
