...
<script type="text/javascript">
        ...
        function refreshIt() {
            publishEvent(SUMMARY_TABLE_UTIL.getRefreshFullTopic("dealerPartReturnConfigTable"));
        }
      
        function exportToExcel(){
            exportExcel("/partReturnDealerConfig/populateCriteria","export_part_return_dealer_config_to_excel.action");
        }
        
        dojo.addOnLoad(function(){
        	dojo.style(dojo.byId("dealerPartReturnConfigTable_summaryTable_showHidePreview"),"display","none");
        });
...
<u:body>
	...
	<div dojoType="dijit.layout.ContentPane" layoutAlign="top"
		...
		cssClass="refresh_button" summaryTableId="dealerPartReturnConfigTable" /> 
		...
		summaryTableId="dealerPartReturnConfigTable" /></div>
	...
	<u:summaryTable 
		...
		id="dealerPartReturnConfigTable"
		bodyUrl="get_dealer_part_return_definition_body.action?"
		folderName="%{folderName}"
		previewPaneId="preview" parentSplitContainerId="split"
		populateCriteriaDataOn="/partReturnDealerConfig/populateCriteria" >
