...
<body>
    <u:actionResults/>
  <s:form action="uploadItemPrices.action?type=Itemprice" method="post" enctype="multipart/form-data">
    <div >
        <p style="padding:5px;">
          <a href="downloadTemplate.action?type=itemprice"><s:text name="link.manageData.downloadPartPriceTemplateFile"/> </a>
          <br>
          <br>
