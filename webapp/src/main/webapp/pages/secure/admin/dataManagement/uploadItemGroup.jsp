...
<body>
    <u:actionResults/>
  <s:form action="uploadItemGroup.action?type=itemgroup" method="post" enctype="multipart/form-data">
    <div >
        <p style="padding:5px;">
          <a href="downloadTemplate.action?type=itemgroup"><s:text name="link.manageData.downloadProductStructureTemplateFile"/></a>
          <br>
          <br>
