...
<body>
    <u:actionResults/>
  <s:form action="uploadItem.action?type=item" method="post" enctype="multipart/form-data">
    <div >
        <p style="padding:5px;">
          <a href="downloadTemplate.action?type=item"><s:text name="link.manageData.downloadItemTemplateFile"/></a>
          <br>
          <br>
