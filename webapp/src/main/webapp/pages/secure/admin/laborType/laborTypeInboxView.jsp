...
<head>
    ...
    <script type="text/javascript">
        ...
        function createLaborType() {
			var url = "initialize_laborType.action";
            parent.publishEvent("/tab/open", {
                url: url,
                label: i18N.create_laborType,
        ...
        function exportToExcel() {
        	exportExcel("/laborType/populateCriteria","exportDataToExcel.action");
        }
  ...
  <div dojoType="dijit.layout.LayoutContainer" style="width: 100%; height: 100%">
    <div dojoType="dijit.layout.ContentPane" layoutAlign="top" class="buttonContainer" id="buttonsDiv">
        ...
        <u:summaryTableButton id="refreshButton" label="button.common.refresh"
                    ...
                    summaryTableId="laborTypeTable"/>
        <u:summaryTableButton id="createLaborTypeButton"
                    label="button.laborType.createLaborType"
                    onclick="createLaborType"
                    summaryTableId="laborTypeTable"
    ...
    <div dojoType="dijit.layout.SplitContainer" layoutAlign="client"
        ...
        <u:stylePicker fileName="SummaryTableButton.css" /> 
                <u:summaryTable eventHandlerClass="tavant.twms.summaryTable.BasicTwmsEventHandler" id="laborTypeTable"
                          bodyUrl="get_laborType.action" 
                          folderName="LABORTYPE" 
                          previewUrl="preview_laborType.action"
                          detailUrl="detail_laborType.action" 
                          previewPaneId="preview"
                          parentSplitContainerId="split"
                          populateCriteriaDataOn="/laborType/populateCriteria">
