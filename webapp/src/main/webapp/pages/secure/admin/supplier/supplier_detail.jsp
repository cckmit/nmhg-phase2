  ...
  <div id="supplier_details" class="policy_section_div" >
	<div id="supplier_details_title" class="section_header">
	   ...
	   <table width="96%" cellpadding="0" cellspacing="0" class="grid"
			...
			<tr>
					<td class="labelStyle"><s:text name="label.name" /></td>
					<td ><s:property value="supplier.name" /></td>
					<td class="labelStyle"><s:text name="label.supplierNumber" /></td>
					<td><s:property value="supplier.supplierNumber" /></td>
			</tr>
			<tr>
					<td class="labelStyle"><s:text name="label.address" /></td>
			...
			<tr>
					<td class="labelStyle"><s:text name="label.phone" /></td>
					<td><s:property value="supplier.address.phone" /></td>
					<td class="labelStyle"><s:text name="label.email" /></td>
					<td><s:property value="supplier.address.email" /></td>
			</tr>
			<tr>
					<td class="labelStyle"><s:text name="label.fax" /></td>
					<td><s:property value="supplier.address.fax" /></td>
			</tr>	
	   </table>	
     </div>	
      <div align="center">
         <s:submit cssClass="buttonGeneric" value="%{getText('button.common.cancel')}" onclick="javascript:closeTab(getTabHavingLabel(getMyTabLabel()));"/>
      </div>   
   </div>
