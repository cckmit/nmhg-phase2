...
<html>
<head>
    <title><s:text name="label.campaigns.updateCampaignRequestsInboxView"/></title>
    <s:head theme="twms"/>
    ...
    <script type="text/javascript">
        ...
        function exportToExcel() {
        	exportExcel("/notification/populateCriteria","exportUpdatedCampNotificationsToExcel.action");
        }
  ...
  <div dojoType="dijit.layout.LayoutContainer" style="width: 100%; height: 100%">
    ...
    <div dojoType="dijit.layout.SplitContainer" layoutAlign="client" orientation="vertical" sizerWidth="4" activeSizing="false" id="split" persist="false">
        <u:stylePicker fileName="SummaryTableButton.css" /> <u:summaryTable eventHandlerClass="tavant.twms.summaryTable.BasicTwmsEventHandler" id="notificationTable" bodyUrl="get_UpdateCampaignAssignments.action" folderName="%{folderName}"
        				  previewUrl="preview_assignment.action" detailUrl="updated_camp_item_view.action"
