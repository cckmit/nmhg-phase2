...
<table id="policiesList" cellspacing="0" cellpadding="0" class="grid borderForTable" style="width: 98%; margin: 7px 0 0 7px;">
    <thead>
        <tr>
    ...
    <tbody>
        <tr>
            <td style="border-top:1px solid #fff;border-bottom:1px solid #fff;border-right:1px solid #fff">
                <s:property value="majorComponent.serialNumber" />
            </td>
            <td style="border-right:1px solid #fff;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="border:1px solid #fff;">
                                <s:property value="price.breachEncapsulationOfCurrency().currencyCode"/>
                                <s:property value="price.breachEncapsulationOfAmount()"/>
                            </td>                           
                        </tr>
				        </s:iterator>
                    </tbody>
             ...
             <td style="border-top:1px solid #fff;border-bottom:1px solid #fff;">
                <s:property value="getPolicyFeeTotalForMajorComp()"/>
           </td>
       </tr>     
    </tbody>
</table>    