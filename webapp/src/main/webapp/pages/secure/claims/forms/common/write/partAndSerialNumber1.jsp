...
<%@taglib prefix="t" uri="twms"%><%@taglib prefix="u" uri="/ui-ext"%>
		...
		<tr>
			<s:if test="claim == null || claim.id == null">
				...
				<td width="35%">
					<sd:autocompleter id='brandPartNumber' href='list_items_parts_claim.action?selectedBusinessUnit=%{selectedBusinessUnit}&dealerBrandsOnly=true&claimBrand=%{claim.brand}'
					...
					indicator='indicator' key='%{claim.brandPartItem.id}' listenTopics="/dealer/modified" keyValue="%{claim.brandPartItem.id}" value='%{claim.brandPartItem.itemNumber}' />
