...
<html>
	<head>
		...
		<title><s:text name="title.viewClaim.smReviewPreview"/></title>
        <s:head theme="twms" />
	...
	<div dojoType="dijit.layout.LayoutContainer">
		<div  dojoType="dijit.layout.TabContainer" tabPosition="bottom" layoutAlign="client">
			<div dojoType="dijit.layout.ContentPane" title="<s:text name="title.viewClaim.header" />" style="overflow-X: hidden; overflow-Y: auto">
    ...
    <s:if test="task.partsClaim && task.claim.partItemReference.serialized">    
        ...
        <div class="policy_section_div">
			...
			<s:if test="(task.partsClaim && !task.claim.partInstalled)||(task.partsClaim && task.claim.partInstalled && task.claim.competitorModelBrand!=null)">
...
<%-- 
			<div dojoType="dijit.layout.ContentPane" title="<s:text name="title.viewClaim.actions"/>" style="overflow-X: hidden; overflow-Y: auto">
				<div >
					<div class="section_header"><s:text name="label.viewClaim.actions"></s:text></div>
					<s:form action="claim_submit" method="post">
						<s:hidden name="id" value="%{task.taskId}"/>
