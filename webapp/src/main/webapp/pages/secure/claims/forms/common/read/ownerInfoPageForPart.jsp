...
dojo.addOnLoad(function() {
    ...
    if(dojo.byId("show_owner_info_for_part")){
    dojo.connect(dojo.byId("show_owner_info_for_part"),"onclick",function() {
...
<div id="ownerInfo" dojoType="twms.widget.Dialog" title="<s:text name="label.matchRead.ownerInformation"/>" 
	...
	<tr>
	    ...
	    <td class="non_editable">	        	
	       	<s:property value="claim.partItemReference.referredInventoryItem.ownedBy.address.addressLine1"/>
	       	    <s:hidden name="travel_location1" value="%{claim.partItemReference.referredInventoryItem.ownedBy.address.locationForGoogleMap}"/>
	    </td>
	</tr>
	<tr>
	      <td class="labelStyle">
	       ...
	       <td class="non_editable">
	          <s:property value="claim.partItemReference.referredInventoryItem.ownedBy.address.city"/>
	       </td>
	</tr>
	<tr>
	     <td class="labelStyle">
	     ...
	     <td class="non_editable">
	         <s:property value="claim.partItemReference.referredInventoryItem.ownedBy.address.state"/>
	     </td>
	</tr>	     
	<tr>
	     <td class="labelStyle">
	     ...
	     <td class="non_editable">
	         <s:property value="claim.partItemReference.referredInventoryItem.ownedBy.address.zipCode"/>
	     </td>
	</tr>
	<tr>
	    <td class="labelStyle">
	    ...
	    <td class="non_editable">
	       <s:property value="claim.partItemReference.referredInventoryItem.ownedBy.address.country"/>
	    </td>
	 </tr>
	 <tr>
	      <td class="labelStyle">
	      ...
	      <td class="non_editable">
	          <s:property value="claim.partItemReference.referredInventoryItem.ownedBy.getType()"/>
	      </td>
	 </tr>   
</table>
