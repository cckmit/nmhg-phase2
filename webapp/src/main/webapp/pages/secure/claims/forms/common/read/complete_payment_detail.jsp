    ...
    <table id="percentage_payment" width="96%" >
        <thead>
            <tr>
                ...
                <th style="text-align:center;" width="15%" class="labelStyle"><s:text name="label.newClaim.percentageAcceptedForCP"/></th>
                <th style="text-align:right;padding-right:5px" width="15%" class="labelStyle"><s:text name="label.newClaim.acceptedAmount.for.cp"/></th>
                </s:if> --%>
            </tr>
        </thead>	
        <tbody>
      ...
      <%--           <s:if test="name=='Late Fee'">
            ...
            <!--  NMHGSLMS-425 Changes(Total Claim amount is not required ) --> 
            ...
            <s:if test="claim.payment.activeCreditMemo != null">
               ...
               <tr class="total">
                ...
                <s:set name="setPayment" value="%{claim.getPayment()}"/>
                    ...
                    <tr class="total">
                        <td colspan="2" style=""><s:text name="label.common.approvedClaimAmount"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;<s:property value="#setSummationLig.getAdditionalPaymentInfoOfType(@tavant.twms.domain.claim.payment.AdditionalPaymentType@ACCEPTED_FOR_WNTY)"/> </td>
                        <%-- <td nowrap="nowrap" style="padding-left: 10px;   padding-bottom: 10px;text-align:right;" class="numeric"></td>
                        <td nowrap="nowrap" style="padding-left: 10px;   padding-bottom: 10px;text-align:right;" class="numeric"></td>
                        <td nowrap="nowrap" style="padding-left: 10px;   padding-bottom: 10px;text-align:right;" class="numeric"></td> --%>
                      <%--   <td class="numeric" style="text-align:right;">
             ...
             <%--    <s:if test="isCPAdvisorEnabled()">
                    ...
                    <s:set name="setSummationLig" value="#setPayment.getLineItemGroup('Claim Amount')"/>
                    <tr class="total">
                        <td colspan="2" style=""><s:text name="label.common.amountAccepted.warranty"/></td>
                        <td nowrap="nowrap" style="padding-left: 10px;   padding-bottom: 10px;text-align:right;" class="numeric"></td>
                        <td nowrap="nowrap" style="padding-left: 10px;   padding-bottom: 10px;text-align:right;" class="numeric"></td>
                        <td nowrap="nowrap" style="padding-left: 10px;   padding-bottom: 10px;text-align:right;" class="numeric"></td>
                        <td class="numeric" style="text-align:right;">
                    ...
                    <tr class="total">
                        <td colspan="2"   style=""><s:text name="label.common.amountAccepted.cp"/></td>
                        <td nowrap="nowrap" style="padding-left: 10px;   padding-bottom: 10px;text-align:right;" class="numeric"></td>
                        <td nowrap="nowrap" style="padding-left: 10px;   padding-bottom: 10px;text-align:right;" class="numeric"></td>
                        <td nowrap="nowrap" style="padding-left: 10px;   padding-bottom: 10px;text-align:right;" class="numeric"></td>
                        <td class="numeric" style="text-align:right;">
