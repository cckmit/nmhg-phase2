...
<head>
    ...
    <script type="text/javascript">
	    ...
	    function exportToExcel(){
         exportExcel("/claimSearch/populateCriteria","exportRecoveryClaimSearchToExcel.action");
        }
...
<u:body>
  <div dojoType="dijit.layout.LayoutContainer" layoutChildPriority="top-bottom" style="width: 100%; height: 100%">
    ...
    <div dojoType="dijit.layout.SplitContainer" layoutAlign="client" orientation="vertical" sizerWidth="4" activeSizing="false" id="split" persist="false">
      ...
      <u:stylePicker fileName="SummaryTableButton.css" /> <u:summaryTable eventHandlerClass="tavant.twms.summaryTable.BasicTwmsEventHandler" id="claimSearchTable" bodyUrl="recoveryClaimSearchSummaryBody.action" extraParamsVar="extraParams"
        ...
        <s:iterator value="tableHeadData">
          <u:summaryTableColumn id="%{id}" label="%{title}" width="%{widthPercent}" idColumn="%{idColumn}"
             labelColumn="%{labelColumn}" hidden="%{hidden}" disableFiltering="%{disableFiltering}"
