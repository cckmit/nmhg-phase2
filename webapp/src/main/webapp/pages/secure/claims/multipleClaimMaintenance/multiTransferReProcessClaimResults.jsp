...
<table  cellspacing="0" cellpadding="0" id="claim_details_table"  class="grid borderForTable" style="clear: both;">
    <thead>    
        <tr>        
            ...
            <th class="warColHeader" width="8%" class="non_editable"><s:text name="columnTitle.common.claimNo"/></th>
            ...
            <th class="warColHeader" width="10%"><s:text name="label.claim.workOrderNumber"/></th>
            <th class="warColHeader" width="10%"><s:text name="label.common.faultCode"/></th>
            <th class="warColHeader" width="10%"><s:text name="label.common.dateOfClaim"/></th>
