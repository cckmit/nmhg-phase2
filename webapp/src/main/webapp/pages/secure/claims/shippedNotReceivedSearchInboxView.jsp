...
<html>
<head>
    <title><s:text name="label.jbpm.task.part.shipped.not.received"/></title>
    <s:head theme="twms"/>
    ...
    <script type="text/javascript">
        ...
        function refreshIt() {
            publishEvent(SUMMARY_TABLE_UTIL.getRefreshFullTopic("shippedNotReceivedSearchTable"));
        }
       
        function exportToExcel(){
        	exportExcel("/claim/populateCriteria","exportShippedNotReceivedSearchResultToExcel.action");
        }
  ...
  <div dojoType="dijit.layout.LayoutContainer" style="width: 100%; height: 100%">
    <div dojoType="dijit.layout.ContentPane" layoutAlign="top" class="buttonContainer"  style="height:32px;">
        ...
        <u:summaryTableButton id="refreshButton" label="button.common.refresh" onclick="refreshIt" align="right" cssClass="refresh_button" summaryTableId="shippedNotReceivedSearchTable"/>
        
        <u:summaryTableButton id="downloadListing" label="button.common.downloadToExcel" onclick="exportToExcel"
               align="right" cssClass="download_to_excel_button" summaryTableId="shippedNotReceivedSearchTable"/>
        </div>
        ...
        <u:summaryTable eventHandlerClass="tavant.twms.summaryTable.BasicTwmsEventHandler" id="shippedNotReceivedSearchTable"
                        bodyUrl="partShippedNotReceivedSearchSearchResult.action" folderName="%{folderName}"
  ...
  <script>
    ...
    if (obj != undefined) {
  	...
  	summaryTableVars.shippedNotReceivedSearchTable.extraParamsVar={
