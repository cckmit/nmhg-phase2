...
<head>
    ...
    <script type="text/javascript">
	    ...
	    function exportToExcel(){
         exportExcel("/claimSearch/populateCriteria","exportPreDefinedRecoveryClaimSearchesToExcel.action");
        }
        
        function handleShowSearch(event, dataId) {
          var formObj = dojo.byId("recoveryInbox");
          formObj.action = "showPreDefinedRecoveryClaimsSearchQuery.action";
          formObj.submit();
...
<u:body>
  <div dojoType="dijit.layout.LayoutContainer" layoutChildPriority="top-bottom" style="width: 100%; height: 100%">
    ...
    <form name="recoveryInbox" id="recoveryInbox" >    
    ...
    <div dojoType="dijit.layout.SplitContainer" layoutAlign="client" orientation="vertical" sizerWidth="4" activeSizing="false" id="split" persist="false">
      ...
      <u:stylePicker fileName="SummaryTableButton.css" /> <u:summaryTable eventHandlerClass="tavant.twms.summaryTable.BasicTwmsEventHandler" 
             id="claimSearchTable" bodyUrl="preDefinedRecoveryClaimsBody.action" extraParamsVar="extraParams"
             folderName="%{folderName}" previewUrl="recovery_claim_search_preview.action" detailUrl="recovery_claim_search_detail.action"
             previewPaneId="preview" parentSplitContainerId="split"  populateCriteriaDataOn="/claimSearch/populateCriteria">
