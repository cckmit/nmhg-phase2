...
<head>
    ...
    <script type="text/javascript">
	    ...
	    function exportToExcel(){
         exportExcel("/claimSearch/populateCriteria","exportClaimSearchToExcel.action");
        }
	    ...
	    function getPageUrl() {
	    	return 'dynamicClaimSearchResult.action?domainPredicateId=<s:property value="domainPredicateId"/>&'+
...
<u:body>
  <div dojoType="dijit.layout.LayoutContainer" style="width: 100%; height: 100%">
    ...
    <div dojoType="dijit.layout.SplitContainer" layoutAlign="client" orientation="vertical" sizerWidth="4" activeSizing="false" id="split" persist="false">
      ...
      <u:stylePicker fileName="SummaryTableButton.css" /> <u:summaryTable eventHandlerClass="tavant.twms.summaryTable.BasicTwmsEventHandler" id="claimSearchTable" 
      		bodyUrl="claimSearchSummaryBody.action" extraParamsVar="extraParams"
             folderName="%{folderName}" previewUrl="view_search_preview.action" detailUrl="view_search_detail.action"
