...
<html>
<head>
    <title><s:text name="label.complaints.updateComplaintPage2"/></title>
    <s:head theme="twms"/>
...
<s:form method="post" theme="twms" validate="true" id="form"
        name="updateCompleteComplaint" action="update_complaint.action">
	<u:actionResults/>
		...
		<table class="form" cellpadding="0" cellspacing="0">
			<s:if test="vehicleInfoType.equals('serial') || vehicleInfoType.equals('item')">
				<tr>
					...
					<td><s:property value="complaint.itemReference.unserializedItem.alternateNumber"/></td>					
				</tr>						
				<tr>
					<td><label class="labelStyle"><s:text name="label.common.product" />:</label></td>
					<td><s:property value="complaint.itemReference.unserializedItem.make"/></td>
					<td><label class="labelStyle"><s:text name="label.common.model" />:</label></td>
					<td><s:property value="complaint.itemReference.unserializedItem.model.name"/></td>
					<td><label class="labelStyle"><s:text name="label.common.year" />:</label></td>
					<td><s:property value="complaint.itemReference.unserializedItem.year"/></td>						
				</tr>			
			</s:if>
			<s:else>				
				<tr>
    ...
    <div style="display: none">
        <div dojoType="twms.widget.Dialog" id="browserForFaultCode" bgColor="#FFF" bgOpacity="0.5" toggle="fade" toggleDuration="250">
            <div dojoType="dijit.layout.LayoutContainer" style="width:500px; height:400px; background:#F3FBFE; 
			border: 1px solid #EFEBF7; border-top : none !important; padding: 0px; margin: 0px;overflow:hidden">
                ...
                <div dojoType="dijit.layout.ContentPane" layoutAlign="client"  style="background:#F3FBFE;font-size: 9pt">
				   ...
				   <div dojoType="dijit.layout.ContentPane" layoutALign="bottom" style="border-top:1px solid #EFEBF7">
                    <button id="addFaultCode">Set Fault Code</button>
                </div>
            </div>
        </div>
    </div>
		...
		<table class="form" cellpadding="0" cellspacing="0">
			...
			<tr>
	            ...
	            <td> 
	                ...
	                <script type="text/javascript">
	                dojo.addOnLoad(function() {
						placeHoldingDiv = dojo.byId("stateTypeComponent");			                	
	                	usComponent = dojo.byId("usComponent");
	                	canadaComponent = dojo.byId("canadaComponent");
	                	otherComponent=dojo.byId("otherComponent");
    ...
    <div align="center" border="0" cellpadding="0" cellspacing="0" class="buttons spacingAtTop">
      
                    <s:submit value="%{getText('button.common.update')}" type="input" name="userAction"/>
                </div>
</s:form>
</u:body>
</html>