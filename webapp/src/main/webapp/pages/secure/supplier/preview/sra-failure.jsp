...
<div class="bgColor" style="width: 98%">
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="4" nowrap="nowrap" class="sectionTitle"><s:text name="label.claim.failureDetails"/></td>
        </tr>
        <tr>
          <td width="14%" nowrap="nowrap" class="labelNormal"><s:text name="label.supplier.causalPartNumber"/> </td>
        ...
        <tr>
          <td width="14%" nowrap="nowrap" class="labelNormal"><s:text name="label.common.faultCode"/>:</td>
          <td width="36%" class="label" colspan="3" ><s:property 
          	value="claim.serviceInformation.faultCode"/></td>
        </tr>
        <tr>
          <td width="14%" nowrap="nowrap" class="labelNormal"><s:text name="label.common.faultFound"/>:</td>
          <td width="36%" class="label"><s:property value="claim.serviceInformation.faultFound.name"/></td>
          <td width="14%" class="labelNormal"><s:text name="label.supplier.causedBy"/></td>
