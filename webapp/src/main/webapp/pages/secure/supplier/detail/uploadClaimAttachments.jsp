...
<table id="claim_attachments_table" class="grid borderForTable" style="width:97%">
    ...
    <tbody id="claim_attachment_table_tbody"/>
</table>
<u:jsVar varName="claimAttachmentRowTemplate">
    <tr>
...
<script type="text/javascript">
    dojo.addOnLoad(function() {
        var alreadyPresentDocs = <s:property value="JSONifiedClaimAttachmentList" escape="false"/>;
        var uploadManager = new twms.claim.AttachmentUploadRenderer(dojo.byId("claim_attachment_table_tbody"),
                                                                    claimAttachmentRowTemplate,
                                                                    <s:property value="JSONifiedClaimAttachmentList" escape="false"/>);
    });
