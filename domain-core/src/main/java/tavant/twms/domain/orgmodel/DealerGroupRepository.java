 ...
 * 
 */
public interface DealerGroupRepository extends
		GenericRepository<DealerGroup, Long> {
    ...
    public List<ServiceProvider> findProvidersAtAllLevelForGroupByGroupId(Long id);
