...
public class RoleScheme implements BusinessUnitAware, Serializable,
		AuditableColumns {

	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(generator = "RoleScheme")
	@GenericGenerator(name = "RoleScheme", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator", parameters = {
			@Parameter(name = "sequence_name", value = "ROLE_SCHEME_SEQ"),
	...
	public RoleScheme(String name) {
		super();
		this.name = name;
	}

	public RoleGroup createRoleGroup(String name, String description) {
