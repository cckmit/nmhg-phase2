...
public class EqualsEnum implements BinaryPredicate,ExpressionToken {
    ...
    public EqualsEnum(Value oneValue, Value anotherValue) {
    ...
    public String getDomainTerm() {
        return "label.operators.equalsEnum";
    }    
    
    public Predicate getInverse() {
		return new NotEqualsEnum(lhs,rhs);
	}
