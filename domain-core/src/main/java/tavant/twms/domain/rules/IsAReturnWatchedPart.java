...
@XStreamAlias("isAReturnWatchedPart")
public class IsAReturnWatchedPart implements MethodInvocation, Predicate,
		Actionable {
	private DomainSpecificVariable domainVariable;

	private MethodInvocationTarget itemGroupService;

	private String methodName = "isPartInReturnWatchList";

	public IsAReturnWatchedPart() {
		super();
	}

	public IsAReturnWatchedPart(DomainSpecificVariable domainVariable) {
		super();
	...
	public String getDomainTerm() {
		return "label.operators.isInPartsReturnWatchList";
	}
	...
	public PredicateEvaluationAction getAction() {
        return PredicateEvaluationActionFactory.getInstance().getActionForIsAReturnWatchedPart(getDomainVariable());
	}
