...
public class NotEquals implements BinaryPredicate,ExpressionToken,Visitable {
    ...
    public NotEquals(Value oneValue, Value anotherValue) {
    ...
    public String getToken() {
        Equals equalsPredicate = new Equals(lhs,rhs);
        Not notOfEquals = new Not(equalsPredicate);
        return notOfEquals.getToken();
    }
