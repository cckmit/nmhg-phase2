 ...
 *
 */
public class DoesNotStartWith implements BinaryPredicate {
    ...
    public DoesNotStartWith(Value lhs, Value rhs) {
        super();
        this.lhs = lhs;
        this.rhs = rhs;
    }
    ...
    public String getDomainTerm() {
        return "label.operators.doesNotStartWith";
    }
