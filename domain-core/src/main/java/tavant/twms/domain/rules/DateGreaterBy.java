...
@XStreamAlias("greaterBy")
public class DateGreaterBy extends AbstractDateDurationPredicate {

	public DateGreaterBy(DomainSpecificVariable lhs, Constant duration,
			int durationType) {
		super(lhs, duration, durationType);
	}

	public DateGreaterBy(DomainSpecificVariable oneValue,
			DomainSpecificVariable dateToCompare, Constant anotherValue,
			int durationType) {
		super(oneValue, dateToCompare, anotherValue, durationType);
	}

	public DateGreaterBy() {
	}
	...
	public String getDomainTerm() {
		return "label.operators.isGreaterBy";
	}
