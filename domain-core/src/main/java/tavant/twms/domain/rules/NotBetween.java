...
public class NotBetween implements Predicate, Visitable {
	...
	public NotBetween(Value lhs, Constant startingRhs, Constant endingRhs) {
	...
	public String getDomainTerm() {
		return "label.operators.notbetween";
	}

	public Predicate getInverse() {
		Between bw = new Between(lhs, startingRhs, endingRhs);
		bw.setInclusive(!inclusive);
		return bw;
	}
}
