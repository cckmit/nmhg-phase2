...
public class GreaterThanOrEquals implements BinaryPredicate,ExpressionToken {
    ...
    public GreaterThanOrEquals(Value oneValue, Value anotherValue) {
    ...
    public String getDomainTerm() {
        return "label.operators.isGreaterThanOrEqualTo";
    }
