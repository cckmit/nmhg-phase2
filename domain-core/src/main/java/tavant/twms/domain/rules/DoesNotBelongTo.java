...
@XStreamAlias("doesNotBelongTo")
public class DoesNotBelongTo implements MethodInvocation, Predicate, Actionable {
	...
	private String methodName = "isBusinessObjectNotInNamedCategory";

	public DoesNotBelongTo() {
		super();
	}

	public DoesNotBelongTo(DomainSpecificVariable domainVariable, Value watchedList) {
		super();
	...
	public String getDomainTerm() {
		return "label.operators.doesNotBelongTo";
	}
	...
	public PredicateEvaluationAction getAction() {
        return PredicateEvaluationActionFactory.getInstance().getActionForDoesNotBelongTo(getDomainVariable(), getWatchedList());
	}
}
