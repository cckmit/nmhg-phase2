...
@XStreamAlias("notLesserBy")
public class DateNotLesserBy extends AbstractDateDurationPredicate {


    public DateNotLesserBy(DomainSpecificVariable oneValue,
    ...
    public String getDomainTerm() {
        return "label.operators.isNotLesserBy";
    }
