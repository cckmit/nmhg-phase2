...
public class LessThanOrEquals implements BinaryPredicate, ExpressionToken {
    ...
    public LessThanOrEquals(Value oneValue, Value anotherValue) {
    ...
    public String getDomainTerm() {
        return "label.operators.isLessThanOrEqualTo";
    }
