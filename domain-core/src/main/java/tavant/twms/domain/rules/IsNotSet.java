 ...
 *
 */
@XStreamAlias("isNotSet")
@Entity
@Table(name="predicate_is_not_set")
@Inheritance(strategy= InheritanceType.JOINED)
public class IsNotSet implements Predicate {
    ...
    //for programmers.
    public IsNotSet(DomainSpecificVariable anotherOperand) {
    ...
    public String getDomainTerm() {
        return "label.operators.isNotSet";
    }
