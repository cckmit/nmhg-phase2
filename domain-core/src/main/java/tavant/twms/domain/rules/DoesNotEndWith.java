 ...
 *
 */
public class DoesNotEndWith implements BinaryPredicate {
    ...
    public DoesNotEndWith(Value lhs, Value rhs) {
        super();
        this.lhs = lhs;
        this.rhs = rhs;
    }
    ...
    public String getDomainTerm() {
        return "label.operators.doesNotEndWith";
    }
