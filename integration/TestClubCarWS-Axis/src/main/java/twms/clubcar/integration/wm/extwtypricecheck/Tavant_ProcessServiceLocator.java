...
public class Tavant_ProcessServiceLocator extends org.apache.axis.client.Service implements twms.clubcar.integration.wm.extwtypricecheck.Tavant_ProcessService {
    ...
    public twms.clubcar.integration.wm.extwtypricecheck.Tavant_ProcessPortType getTavant_ProcessPort0() throws javax.xml.rpc.ServiceException {
    ...
    public twms.clubcar.integration.wm.extwtypricecheck.Tavant_ProcessPortType getTavant_ProcessPort0(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            twms.clubcar.integration.wm.extwtypricecheck.Tavant_ProcessBindingStub _stub = new twms.clubcar.integration.wm.extwtypricecheck.Tavant_ProcessBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (twms.clubcar.integration.wm.extwtypricecheck.Tavant_ProcessPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                twms.clubcar.integration.wm.extwtypricecheck.Tavant_ProcessBindingStub _stub = new twms.clubcar.integration.wm.extwtypricecheck.Tavant_ProcessBindingStub(new java.net.URL(Tavant_ProcessPort0_address), this);
                _stub.setPortName(getTavant_ProcessPort0WSDDServiceName());
                return _stub;
            }
        }
