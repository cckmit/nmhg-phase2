...
import twms.clubcar.integration.wm.creditsubmit.Tavant_ProcessPortType;
import twms.clubcar.integration.wm.creditsubmit.Tavant_ProcessService;
import twms.clubcar.integration.wm.creditsubmit.Tavant_ProcessServiceLocator;

public class CreditSubmtWSClient extends WSClient {

	public CreditSubmtWSClient() {
	...
	public void service() {
		...
		try {
			...
			String response = webServiceInterface.processCreditSubmission(xml);
