...
public class CreditSubmissionSchedulerForAmer extends CreditSubmissionScheduler {
	protected static final Logger logger = Logger.getLogger(CreditSubmissionSchedulerForAmer.class);
	...
	protected void executeInternal(JobExecutionContext context)
		...
		logger.error("max nof retries ...."
 		...
 		List<Long> syncTrackerIdsTobeProcessed = syncTrackerDao
				.getIdsForProcessing(
						IntegrationServerConstants.NMHG_US,
						maxNoOfRetries,
						IntegrationServerConstants.CREDIT_SUBMISSION_JOB_UNIQUE_IDENTIFIER);
	...
	public void processCreditSubmissionRecords(
		...
		.updateCreditForAcceptedAndDeniedClaims(IntegrationServerConstants.NMHG_US);
	}
