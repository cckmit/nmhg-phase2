...
public class GlobalOutBoundTest {
	...
	public static void main(String[] args) {
		...
		String requestXML = getRequestXML("creditsubmit","CreditSubmit.xml");
		// Web Method NameSpace
		String wmNamespace = "Route.Inbound.Protocol.SOAP";
		// Web Method WSDL Method
		String methodName = "processSOAPInbound";
		// In Param
	...
	private static String getRequestXML(String syncType,String xmlName) {
		// XML Location
		String sampleXML = "D:/svn-root/TWMS_IRI_HUS_DEV/integration/server/src/test/resources/server/xml/"+syncType+"/"+xmlName;
