--Purpose    : Fixed the ITEM_UPLOAD procedure. Changed column YEAR to ITEM_YEAR. Procedure was written specifically for Hussmann, corrected it to make it generic.
    ...
    BEGIN
      ...
      IF v_need_to_INSERT = 0 THEN
        ...
        SET DESCRIPTION        = EACH_REC.ITEM_DESC,
          ...
          alternate_item_number= EACH_REC.ITEM_NUMBER,
