-- Purpose    : Included rec claim updated on in the view for supplier recovery download
-- Author     : raghuram.d
-- Created On : 18-Jun-09
  ...
  select  
	r.BUSINESS_UNIT_INFO BUSSINESS_UNIT_INFO,r.id,claim_number, r.RECOVERY_CLAIM_STATE,
