--Purpose    : Patch for BuConfig Battery Labor Details
--Author     : saya.sudha	
...
VALUES(config_param_seq.nextval, 'Battery labor details check for claims','is battery labor details applicable','batteryLaborDetailsApplicable','boolean', sysdate,NULL,sysdate,NULL,NULL,sysdate,'radio',NULL,NULL,NULL,NULL,NULL)
/
...
VALUES(config_value_seq.nextval,1,NULL,(select id from config_param where name='batteryLaborDetailsApplicable'),sysdate,NULL,sysdate,NULL,NULL, NULL,'Club Car',(select id from config_param_option where value='false'))
/
insert into config_param_options_mapping values((select max(id) from config_param_options_mapping) +20,
(select id from config_param where name='batteryLaborDetailsApplicable'),
