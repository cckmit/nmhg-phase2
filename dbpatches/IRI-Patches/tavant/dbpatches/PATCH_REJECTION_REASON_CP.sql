-- Patch for Default Rejection Reason for Claim Processing BU
-- 31st March 2009
...
BEGIN
    ...
    values
    (v_config_param_id, 'Default Rejection Reason for Claim Processing', 
    'Default Rejection Reason for Claim Processing', 'defaultRejectionReasonClaimProcessing',
