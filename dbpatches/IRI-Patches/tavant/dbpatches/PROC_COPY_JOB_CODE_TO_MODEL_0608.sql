--Purpose    : Procedure to copy a job code from one model to another
--Author     : raghuram.d
...
BEGIN
    ...
    BEGIN
        SELECT id INTO v_fault_code_id
        FROM fault_code
...
--dbms_output.put_line('created service procedure - ' || v_service_proc_id);
    END;
