    ...
    BEGIN
        ...
        BEGIN
            ...
            WHERE UPPER(dealer_number) = UPPER(each_rec.dealer_number) 
              ...
              IF v_inventory_type='RETAIL' THEN
                ...
                EXCEPTION
                    WHEN NO_DATA_FOUND THEN
                        ...
                        VALUES(v_cust_addr_id, each_rec.address_line1, UPPER(each_rec.country), UPPER(each_rec.state), 
                            UPPER(each_rec.city), each_rec.zipcode,
                            NVL(each_rec.contact_first_name,'') || NVL(' '||each_rec.contact_middle_name,'') || NVL(' '||each_rec.contact_last_name,''),
                ...
                IF UPPER(NVL(each_rec.apply_coverage, 'Y')) = 'Y' THEN
                    ...
                    BEGIN
                        ...
                        BEGIN
                            ...
                            SELECT ADD_MONTHS(TO_DATE(v_warranty_start_date, 'YYYYMMDD'), each_plan.months_frm_delivery)
