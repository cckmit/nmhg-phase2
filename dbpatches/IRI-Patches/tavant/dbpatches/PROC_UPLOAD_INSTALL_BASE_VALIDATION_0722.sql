-- Purpose    : End customer address is renamed to address_line1 in the IB upload template
-- Author     : raghuram.d
...
BEGIN
    ...
    BEGIN
        ...
        IF each_rec.wms_deployment_stack IS NULL
                OR UPPER(each_rec.wms_deployment_stack) != 'IRI' THEN
            v_error_code := common_utils.addErrorMessage(v_error_code, 'IB042');
        END IF;
