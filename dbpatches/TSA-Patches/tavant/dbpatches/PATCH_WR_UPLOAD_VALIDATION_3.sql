    ...
    LOOP
      BEGIN
        ...
        IF V_ADD_INFO_APPLICABLE        = 'TRUE' THEN
          ...
          ELSIF (UPPER(EACH_REC.IF_PREVIOUS_OWNER) <> UPPER(('Switching to ' || EACH_REC.BUSINESS_UNIT_INFO)) AND UPPER(EACH_REC.IF_PREVIOUS_OWNER) <> UPPER(('Continuing with ' || EACH_REC.BUSINESS_UNIT_INFO)) AND UPPER(EACH_REC.IF_PREVIOUS_OWNER) <> UPPER('Unknown/Not Provided')) THEN
