...
AS
  ...
  v_start_dt			DATE;
  v_end_dt			DATE;
  v_service_hrs_covered  NUMBER  := NULL;
BEGIN
  ...
  LOOP
    BEGIN
      ...
      BEGIN
        SELECT ID,service_hrs_covered
        INTO v_policy_def_id,v_service_hrs_covered
    ...
    IF v_policy_id IS NULL THEN
      ...
      INTO POLICY_AUDIT
        ...
        (
          ...
          v_policy_id ,
          sysdate,
          NVL(EACH_REC.HOURS_COVERED,v_service_hrs_covered),
          sysdate,
          sysdate,
          null,
          1
