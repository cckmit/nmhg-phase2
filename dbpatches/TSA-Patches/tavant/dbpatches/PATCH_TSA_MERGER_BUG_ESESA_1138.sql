...
BEGIN
  ...
  LOOP
    BEGIN
	  ...
	  --IF condition added for Deafulting source warehouse value to BGN for Hussmann. (whenever the source warehouse is null)-- 
      ...
      IF v_inventory_type='RETAIL' THEN
	    ...
	    v_fleet_number,
	    v_equipment_vin,
	    nvl(each_rec.installation_date, NULL, TO_DATE(each_rec.installation_date,'YYYYMMDD')),
	    null,
	    null,
	    null,
	    null
          ...
          BEGIN
            ...
            LOOP
              BEGIN
				...
				--ESESA-1082: To check if the START_DATE is greater than the CALCULATED END_DATE. 
				--In such cases we will need to put the START_DATE itself as the END_DATE so that the number of months covered is shown as "Zero"
