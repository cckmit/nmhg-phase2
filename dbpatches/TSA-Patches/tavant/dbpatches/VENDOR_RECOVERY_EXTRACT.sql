...
AS
  SELECT r.BUSINESS_UNIT_INFO BUSINESS_UNIT_INFO,
    ...
    ||to_clob(' ## ')
    ||to_clob(NVL(c.work_performed,''))
    ||to_clob(' ## ')
    ||to_clob(NVL(c.other_comments,'')) dealer_comments,
