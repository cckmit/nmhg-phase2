-- PURPOSE    : PATCH TO ADD CONFIG PARAM FOR Series Failure Hierarchy ADMIN PAGE
...
(
		...
		'Enable Model/Product in Series Failure Hierarchy Page',
		'Enable Model/Product in Series Failure Hierarchy Page',
		'enableModelProductInSeriesFailureHierarchyPage',
		'boolean',
		'',
		'',
		'',
...
(
		...
		1,
		null,
		(SELECT id FROM config_param cp WHERE cp.name='enableModelProductInSeriesFailureHierarchyPage'),
		'',
		null,
		'',
		56,
