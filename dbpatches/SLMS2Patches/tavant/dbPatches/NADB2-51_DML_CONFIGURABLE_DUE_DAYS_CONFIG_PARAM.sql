...
INTO config_param
  ...
  (
    ...
    'Use configurable due days for Part Return',
    'Use configurable due days for Part Return',
    'CLAIMS',
    1,
    'useConfigurableDueDays',
    'radio',
    1,
    'CLAIM_RETURN_PART',
    1,
...
INTO config_param_options_mapping
  ...
  (
    ...
    WHERE cp.description='Use configurable due days for Part Return'
    ),
...
INTO CONFIG_VALUE
  ...
  (
	...
	1,
	(SELECT ID FROM CONFIG_PARAM WHERE NAME='useConfigurableDueDays'),
