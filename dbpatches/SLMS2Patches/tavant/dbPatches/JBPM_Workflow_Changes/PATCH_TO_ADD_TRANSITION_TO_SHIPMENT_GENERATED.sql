...
/
begin
  create_jbpm_transition('PartsReturn','autoConfirmed','Shipment Generated','End','partReturn.setStatus(tavant.twms.domain.partreturn.PartReturnStatus.PART_RECEIVED_BY_SUPPLIER)');   
end;
/
commit
/
