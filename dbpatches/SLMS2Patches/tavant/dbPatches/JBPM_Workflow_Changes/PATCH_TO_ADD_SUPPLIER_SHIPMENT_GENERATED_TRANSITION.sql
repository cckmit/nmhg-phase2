-- Purpose : Patch to create jbpm transitions for Shipment
...
/
begin
  create_jbpm_transition('SupplierPartReturn','autoConfirmed','Part Shipper Update Tag','End','supplierPartReturn.setStatus(tavant.twms.domain.partreturn.PartReturnStatus.PART_RECEIVED)');   
end;
/
commit
/
