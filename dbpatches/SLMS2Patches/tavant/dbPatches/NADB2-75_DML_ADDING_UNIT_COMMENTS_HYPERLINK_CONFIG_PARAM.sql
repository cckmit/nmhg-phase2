-- PURPOSE    : PATCH TO ADD CONFIG PARAM FOR View Unit Comments Hyperlink
-- AUTHOR     : Priyanka S.
...
VALUES (
		...
		'Enable View Unit Comments Hyperlink',
		'Enable View Unit Comments Hyperlink',
		'enableUnitCommentsHyperlink',
		'boolean',
		'',
		'',
		'',
...
(
		...
		1,
		null,
		(SELECT id FROM config_param cp WHERE cp.name='enableUnitCommentsHyperlink'),
		'',
		null,
		'',
		56,
