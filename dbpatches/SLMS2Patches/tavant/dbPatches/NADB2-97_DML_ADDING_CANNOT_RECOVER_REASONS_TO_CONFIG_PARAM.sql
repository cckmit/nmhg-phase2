...
VALUES (
		...
		'Request for Part from supplier on VR claim Rejection',
		'Request for Part from supplier on VR claim Rejection',
		'requestForPartFromSupplierOnVRClaimRejection',
		'boolean',
		'',
		'',
		'',
...
VALUES 
	(
		...
		1,
		null,
		(SELECT id FROM config_param cp WHERE cp.name='requestForPartFromSupplierOnVRClaimRejection'),
		'',
		null,
		'',
		56,
