...
INTO config_param
  ...
  (
    ...
    'Enable recovery part return directly through dealer',
    'Enable recovery part return directly through dealer',
    'SUPPLIER_RECOVERY',
    1,
    'enablePartRecoveryThroughDealer',
    'radio',
    1,
    'null',
    1,
...
INTO config_param_options_mapping
  ...
  (
    ...
    WHERE cp.description='Enable recovery part return directly through dealer'
    ),
...
INTO CONFIG_VALUE
  ...
  (
	...
	1,
	(SELECT ID FROM CONFIG_PARAM WHERE NAME='enablePartRecoveryThroughDealer'),
