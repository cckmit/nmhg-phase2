...
INTO config_param
  ...
  (
    ...
    'Display brand drop down for Parts claim',
    'Display brand drop down for Parts claim',
    'CLAIMS',
    1,
    'displayBrandDropdownForPartsClaim',
    'radio',
    1,
...
INTO config_param_options_mapping
  ...
  (
    ...
    WHERE cp.description='Display brand drop down for Parts claim'
    ),
...
INTO CONFIG_VALUE
  ...
  (
	...
	1,
	(SELECT ID FROM CONFIG_PARAM WHERE NAME='displayBrandDropdownForPartsClaim'),
