--PURPOSE    : PATCH FOR UPDATING STORED PROCEDURE UPLOAD_DRAFT_CLAIM_VALIDATION
--AUTHOR     : VAMSI KRISHNA JOLLA
--CREATED ON : 26-MAR-13
       ...
       IF EACH_REC.ALARM_CODES IS NOT NULL THEN          
        ...
        END IF; 
         EXCEPTION
            ...
            v_error_code := Common_Utils.addErrorMessage(v_error_code, 'DC067_IAC');
     END;
  IF UPPER(EACH_REC.CLAIM_TYPE) IN ('MACHINE SERIALIZED', 'MACHINE NON SERIALIZED', 'PARTS WITH HOST', 'FIELDMODIFICATION')
  THEN
