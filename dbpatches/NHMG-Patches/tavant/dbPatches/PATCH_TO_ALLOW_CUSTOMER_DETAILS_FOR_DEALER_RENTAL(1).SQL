--Purpose    : Patch for adding a BU configuration to allow customer details on DealerRental
...
INTO config_param
  ...
  (
    ...
    'Allow customer details on dealer rental?',
    'Allow customer details on dealer rental? :',
    'INVENTORY',
    1,
    'customerDetailsAllowedForDealerRental',
    'radio',
    1,
    'INVENTORY_DR',
    1,
...
INTO config_param_options_mapping
  ...
  (
    ...
    WHERE cp.description='Allow customer details on dealer rental?'
    ),
