...
INTO CONFIG_VALUE
  ...
  (
	...
	1,
	(SELECT ID FROM CONFIG_PARAM WHERE NAME='showAuthorizationNumber'),
	(SELECT ID from CONFIG_PARAM_OPTION WHERE VALUE='true'),
	1,
	(SELECT ID FROM ORG_USER WHERE LOGIN='cvpkelly'),
	'AMER'
  )
/
INSERT
INTO CONFIG_VALUE
  ...
  (
	...
	1,
	(SELECT ID FROM ORG_USER WHERE LOGIN='yesmumfo'),
	'EMEA'
  )
/
COMMIT
