-- Patch to insert into config param Show Authorisation Received
...
INTO config_param
  ...
  (
    ...
    'Show Authorisation Received',
    'Show Authorisation Received',
    'CLAIMS',
    1,
    'showAuthorizationReceived',
    'radio',
    1,
...
INTO config_param_options_mapping
  ...
  (
    ...
    WHERE cp.description='Show Authorisation Received'
    ),
