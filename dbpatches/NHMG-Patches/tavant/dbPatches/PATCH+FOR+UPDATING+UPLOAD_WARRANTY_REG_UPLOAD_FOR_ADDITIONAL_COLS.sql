--PURPOSE    : PATCH FOR UPDATING STORED PROCEDURE UPLOAD_WARRANTY_REG_UPLOAD_FOR_ADDITIONAL_COLS
--AUTHOR     : JYOTI CHAUHAN
--CREATED ON : 13-MAR-13
      ...
      BEGIN
        ...
        IF V_END_CUST_ID > 0 THEN
          BEGIN
            ...
            AND II.D_ACTIVE           = 1
            AND II.TYPE               = 'STOCK';
            V_HOURS_ON_SERV:=EACH_REC.HOURS_ON_MACHINE;
