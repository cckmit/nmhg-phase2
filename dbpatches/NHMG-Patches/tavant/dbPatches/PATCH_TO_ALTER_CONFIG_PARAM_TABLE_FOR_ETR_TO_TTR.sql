...
/
update config_param set DISPLAY_NAME='Is Manual Approval Flow required for TTR' , description='Is Manual Approval Flow required for ETR' where DISPLAY_NAME='Is Manual Approval Flow required for ETR'
/
