...
INTO config_param
  ...
  (
    ...
    'Is processor is allowed take action on claim during EPO is down?',
    'Is processor is allowed take action on claim during EPO is down?',
    'CLAIMS',
    1,
    'processorAllowedTakeActionOnClaimsDuringEPOIsDown',
    'radio',
    1,
...
INTO config_param_options_mapping
  ...
  (
    ...
    WHERE cp.description='Is processor is allowed take action on claim during EPO is down?'
    ),
...
1,
null,
(SELECT id FROM config_param WHERE NAME='processorAllowedTakeActionOnClaimsDuringEPOIsDown'),
sysdate,
null,
sysdate,
null,
