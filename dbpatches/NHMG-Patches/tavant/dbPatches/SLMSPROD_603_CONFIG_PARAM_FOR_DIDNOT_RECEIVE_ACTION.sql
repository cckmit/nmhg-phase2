...
INTO config_param
  ...
  (
    ...
    'Mark part as rejected on did not receive',
    'Mark part as rejected on did not receive',
    'CLAIMS',
    1,
    'rejectOnDidnotReceive',
    'radio',
    1,
    'CLAIM_RETURN_PART',
    1,
...
INTO config_param_options_mapping
  ...
  (
    ...
    WHERE cp.description='Mark part as rejected on did not receive'
    ),
...
INTO CONFIG_VALUE
  ...
  (
	...
	1,
	(SELECT ID FROM CONFIG_PARAM WHERE NAME='rejectOnDidnotReceive'),
