-- Patch to insert into config param Show Customer Address State on DR
...
INTO config_param
  ...
  (
    ...
    'Show Customer Address State on DR',
    'Show Customer Address State on DR',
    'INVENTORY',
    1,
    'showCustomerAddressState',
    'radio',
    1,
    'INVENTORY_DR',
    1,
...
INTO config_param_options_mapping
  ...
  (
    ...
    WHERE cp.description='Show Customer Address State on DR'
    ),
