ALTER TABLE STG_WARRANTY_REGISTRATIONS ADD CUSTOMER_REPRESENTATIVE VARCHAR2(255)
/
update upload_mgt set columns_to_capture=25 where name_of_template='warrantyRegistrations'
/
create or replace
