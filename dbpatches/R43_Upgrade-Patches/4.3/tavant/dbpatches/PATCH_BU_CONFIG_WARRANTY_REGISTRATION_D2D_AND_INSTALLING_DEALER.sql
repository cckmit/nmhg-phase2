--Purpose    : Patch for config param for Installing Dealer and Installation Date in Warranty Registration, changes made as a part of 4.3 upgrade 
...
VALUES
(config_param_seq.NEXTVAL, 'Capture Installing Dealer/Installation Date on WR/ETR', 'Capture Installing Dealer/Installation Date on WR/ETR','enableDealerAndInstallationDate','boolean',sysdate, '4.3 Upgrade',sysdate, 56, sysdate, sysdate, 'INVENTORY', 'radio', 1, 'INVENTORY_DR_ETR', 1,1,1)
/
...
/
INSERT INTO CONFIG_VALUE values (CONFIG_VALUE_SEQ.nextval,1,'',(select id from CONFIG_PARAM where NAME='enableDealerAndInstallationDate'),sysdate,
...
(ID, DESCRIPTION, DISPLAY_NAME, NAME, TYPE, D_CREATED_ON, D_INTERNAL_COMMENTS, D_UPDATED_ON, D_LAST_UPDATED_BY, D_CREATED_TIME, D_UPDATED_TIME, LOGICAL_GROUP, PARAM_DISPLAY_TYPE, LOGICAL_GROUP_ORDER, SECTIONS, SECTIONS_ORDER, PARAM_ORDER,d_active)
VALUES
(config_param_seq.NEXTVAL, 'Perform Dealer to Dealer Transaction on Warranty Registration', 'Perform Dealer to Dealer Transaction on Warranty Registration','performD2DOnWR','boolean',sysdate, '4.3 Upgrade',sysdate, NULL, NULL, 
...
(select id from config_param_option where value='false'))
/
INSERT INTO CONFIG_VALUE values (CONFIG_VALUE_SEQ.nextval,1,'',(select id from CONFIG_PARAM where NAME='performD2DOnWR'),sysdate,
'4.3 Upgrade',sysdate,56,SYSDATE,SYSDATE,1,'Transport Solutions ESA',(select id from CONFIG_PARAM_OPTION where value='false'))
/
INSERT INTO CONFIG_VALUE values (CONFIG_VALUE_SEQ.nextval,1,'',(select id from CONFIG_PARAM where NAME='performD2DOnWR'),sysdate,
'4.3 Upgrade',sysdate,56,SYSDATE,SYSDATE,1,'Hussmann',(select id from CONFIG_PARAM_OPTION where value='false'))
