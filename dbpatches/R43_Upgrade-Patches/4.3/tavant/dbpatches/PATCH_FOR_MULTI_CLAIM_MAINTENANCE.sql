...
CAST(sysdate AS TIMESTAMP),1,'Transport Solutions ESA',null)
/
INSERT INTO CONFIG_VALUE values (CONFIG_VALUE_SEQ.nextval,1,500,
(select id from CONFIG_PARAM where NAME='maxClaimsAllowedForMultiClaimMaintenance'),sysdate,
null,sysdate,null,CAST(sysdate AS TIMESTAMP),
CAST(sysdate AS TIMESTAMP),1,'Hussmann',null)
/
INSERT INTO CONFIG_VALUE values (CONFIG_VALUE_SEQ.nextval,1,500,
(select id from CONFIG_PARAM where NAME='maxClaimsAllowedForMultiClaimMaintenance'),sysdate,
null,sysdate,null,CAST(sysdate AS TIMESTAMP),
CAST(sysdate AS TIMESTAMP),1,'AIR',null)
/
INSERT INTO CONFIG_VALUE values (CONFIG_VALUE_SEQ.nextval,1,500,
(select id from CONFIG_PARAM where NAME='maxClaimsAllowedForMultiClaimMaintenance'),sysdate,
null,sysdate,null,CAST(sysdate AS TIMESTAMP),
CAST(sysdate AS TIMESTAMP),1,'TFM',null)
/
INSERT INTO CONFIG_VALUE values (CONFIG_VALUE_SEQ.nextval,1,500,
(select id from CONFIG_PARAM where NAME='maxClaimsAllowedForMultiClaimMaintenance'),sysdate,
null,sysdate,null,CAST(sysdate AS TIMESTAMP),
CAST(sysdate AS TIMESTAMP),1,'Clubcar ESA',null)
/
Commit
/