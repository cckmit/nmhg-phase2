--Purpose    : Creating eventstate for email notification for duplicate DCAP Claims, changes made as a part of 4.3 upgrade 
--Author     : Saya Sudha
...
VALUES (EVENT_STATE_SEQ.nextval,0,'ATTEMPTING_DUPLICATE_DCAP_CLAIM','Attempting Duplicate Dcap Claim',SYSDATE,null,SYSDATE,null,CAST(sysdate AS TIMESTAMP),CAST(sysdate AS TIMESTAMP),1)
/
