...
CAST(sysdate AS TIMESTAMP),1,'Transport Solutions ESA',(select id from CONFIG_PARAM_OPTION where value='false'))
/
INSERT INTO CONFIG_VALUE values (CONFIG_VALUE_SEQ.nextval,1,'',
(select id from CONFIG_PARAM where NAME='enableReportFilingAnyDealer'),sysdate,
null,sysdate,null,CAST(sysdate AS TIMESTAMP),
CAST(sysdate AS TIMESTAMP),1,'Hussmann',(select id from CONFIG_PARAM_OPTION where value='false'))
/
INSERT INTO CONFIG_VALUE values (CONFIG_VALUE_SEQ.nextval,1,'',
(select id from CONFIG_PARAM where NAME='enableReportFilingAnyDealer'),sysdate,
null,sysdate,null,CAST(sysdate AS TIMESTAMP),
CAST(sysdate AS TIMESTAMP),1,'AIR',(select id from CONFIG_PARAM_OPTION where value='false'))
/
INSERT INTO CONFIG_VALUE values (CONFIG_VALUE_SEQ.nextval,1,'',
(select id from CONFIG_PARAM where NAME='enableReportFilingAnyDealer'),sysdate,
null,sysdate,null,CAST(sysdate AS TIMESTAMP),
CAST(sysdate AS TIMESTAMP),1,'TFM',(select id from CONFIG_PARAM_OPTION where value='false'))
/
INSERT INTO CONFIG_VALUE values (CONFIG_VALUE_SEQ.nextval,1,'',
(select id from CONFIG_PARAM where NAME='enableReportFilingAnyDealer'),sysdate,
null,sysdate,null,CAST(sysdate AS TIMESTAMP),
CAST(sysdate AS TIMESTAMP),1,'Clubcar ESA',(select id from CONFIG_PARAM_OPTION where value='false'))
/
Commit
/