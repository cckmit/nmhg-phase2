...
'Travel Rate Price List','LABOR RATE WEIGHTS','TRAVEL RATE WEIGHTS','PAYMENT MODIFIER WEIGHTS','Dealer Net Discount1','Dealer Net Discount');
V_BUS_UNITS V_ARR :=V_ARR('ITS');
BEGIN
