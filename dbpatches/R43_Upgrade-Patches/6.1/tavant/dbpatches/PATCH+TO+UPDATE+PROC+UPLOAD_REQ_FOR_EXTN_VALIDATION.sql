--PURPOSE    : PATCH TO UPDATE PROC UPLOAD_REQ_FOR_EXTN_VALIDATION
--AUTHOR     : ROHIT MEHROTRA
--CREATED ON : 10TH MAY 2011
--IMPACT	 : REQUEST FOR EXT UPLOAD
  ...
  LOOP
    BEGIN
      ...
      BEGIN
        ...
        AND TAV.ACTION_PERFORMED      IN ('APPROVED', 'FORWARDED', 'DENIED')
        AND ROWNUM                    = 1;
        BEGIN
