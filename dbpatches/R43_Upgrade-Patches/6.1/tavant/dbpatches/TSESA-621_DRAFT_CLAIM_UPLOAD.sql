...
RETURN NUMBER;
 ...
 FUNCTION isValidCampaignCode(p_campaign_code VARCHAR2, p_dealer NUMBER, p_business_unit VARCHAR2,p_date DATE,v_service_provider_number NUMBER,p_serial_number VARCHAR2)
 RETURN BOOLEAN;
...
BEGIN
	...
	FROM item i
	WHERE (lower(i.item_number)=lower(p_item_number)
			OR(lower(i.item_number)!=lower(p_item_number)
				AND lower(i.alternate_item_number)=lower(p_item_number)))
...
/
ALTER TABLE stg_draft_claim ADD serial_number_id NUMBER
/
ALTER TABLE stg_draft_claim ADD item_number_id NUMBER
/
ALTER TABLE stg_draft_claim ADD model_id NUMBER
/
ALTER TABLE stg_draft_claim ADD part_id NUMBER
/
ALTER TABLE stg_draft_claim ADD part_serial_id NUMBER
/
BEGIN		 
create_upload_error ('draftWarrantyClaims','en_US','IS SERIALIZED','DC101',
						'Is Serialized must be left blank or set to Y');
create_upload_error ('draftWarrantyClaims','en_US','IS PART INSTALLED','DC102',
						'Is Part Installed must be set to Y');
create_upload_error ('draftWarrantyClaims','en_US','IS PARAT INSTALLED','DC103',
						'Is Part Installed must be left blank or set to N');
create_upload_error ('draftWarrantyClaims','en_US','CLAIM TYPE','DC104',
		'Part is installed on Unit, please file a serialized parts claim with host');
create_upload_error ('draftWarrantyClaims','en_US','IS SERIALIZED','DC105',
		'Part is installed on Unit, Is Serialized must be left blank or set to Y');
create_upload_error ('draftWarrantyClaims','en_US','COMPETITOR MODEL','DC106',
						'Competitor Model is not specified');
create_upload_error ('draftWarrantyClaims','en_US','IS SERIALIZED','DC107',
						'Is Serialized must set to N');
create_upload_error ('draftWarrantyClaims','en_US','SERIAL NUMBER','DC_SN_INV',
						'Invalid Serial Number');
create_upload_error ('draftWarrantyClaims','en_US','MODEL NUMBER','DC_SN_DUP_M_EMP',
						'Specify Model Number for duplicate Serial Number');
create_upload_error ('draftWarrantyClaims','en_US','MODEL NUMBER','DC_SN_DUP_M_INV',
						'Invalid Model Number for duplicate Serial Number');
create_upload_error ('draftWarrantyClaims','en_US','SERIAL NUMBER','DC_SN_M_DUP',
						'Duplicate Serial Number');
create_upload_error ('draftWarrantyClaims','en_US','SERIAL NUMBER','DC_SN_CUST_INV',
						'Serial Number not allowed');
create_upload_error ('draftWarrantyClaims','en_US','SERIAL NUMBER','DC_SN_DUP',
						'Duplicate Serial Number');
create_upload_error ('draftWarrantyClaims','en_US','CONTAINER NUMBER','DC_CN_INV',
						'Invalid Container Number');
create_upload_error ('draftWarrantyClaims','en_US','CONTAINER NUMBER','DC_CN_DUP',
						'Duplicate Container Number');
create_upload_error ('draftWarrantyClaims','en_US','ITEM NUMBER','DC_IT_INV',
						'Invalid Item Number');
create_upload_error ('draftWarrantyClaims','en_US','ITEM NUMBER','DC_IT_DUP',
						'Duplicate Item Number');
create_upload_error ('draftWarrantyClaims','en_US','MODEL NUMBER','DC_M_INV',
						'Invalid Model Number');
create_upload_error ('draftWarrantyClaims','en_US','MODEL NUMBER','DC_M_DUP',
						'Duplicate Model Number');
create_upload_error ('draftWarrantyClaims','en_US','PART ITEM NUMBER','DC_PRT_INV',
						'Invalid Part Item Number');
create_upload_error ('draftWarrantyClaims','en_US','PART ITEM NUMBER','DC_PRT_DUP',
						'Duplicate Part Item Number');
END;
/