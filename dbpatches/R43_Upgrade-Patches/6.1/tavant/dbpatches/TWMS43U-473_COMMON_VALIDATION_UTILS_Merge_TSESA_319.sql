--Purpose : Merge TSESA-319 from R4. Added 3 functions to common_validation_utils
--          1. getValidCausalPart
--          2. getReplacedIRPartNumber
--          3. getInstalledIRPart
--Author : raghuram.d
--Date : 18/May/2011
...
/
--Purpose : Altered isValidModelForProduct & isValidModelCodeForProduct to handle product structure of TSA as well as other BUs(from R4).
--Author : raghuram.d
--Date : 02/May/2011
