...
PROMPT Message: Next process ==> Create Synonyms using Schema name or DBLink.

PROMPT
PROMPT Message: Please Execute TAV_GIM_CREATE_SYNONYMS_AND_VALIDATE.bat to create synonyms and validate. 
PROMPT
SPOOL OFF

PROMPT User Action: Press 'Enter' to create SYNONYMS (or) Close this window to 'Abort'
PAUSE

@@TAV_GIM_CREATE_SYNONYMS_AND_VALIDATE.sql
